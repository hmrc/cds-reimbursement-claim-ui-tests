Feature: Exploratory file using Cucumber
  ...
  Scenario: User is a CDS Trader - happy path (mrn) - duplicate mrn
    ...
    Then I am presented with the "Mrn_Enter Your Details As Registered With CDS"
    And I select radio button "no" on "Mrn_Enter Your Details As Registered With CDS"
    And I click continue on "Mrn_Enter Your Details As Registered With CDS"
