Feature: Exploratory file using Cucumber
  ...
  Scenario: User is a CDS Trader - happy path (mrn) - duplicate mrn
    ...
    Then I am presented with the "Single_Enter Your Details As Registered With CDS Page"
    And I select radio button "no" on "Single_Enter Your Details As Registered With CDS Page"
    And I click continue on "Single_Enter Your Details As Registered With CDS Page"
    Then I am presented with the "Single_Choose Basis For Claim Page"
    When I select radio button "Duplicate Entry" on "Single_Choose Basis For Claim Page"
    ...
    When I select dropdown value "Commercial invoice" on "Single_Supporting Evidence Select Supporting Evidence Type Page"
