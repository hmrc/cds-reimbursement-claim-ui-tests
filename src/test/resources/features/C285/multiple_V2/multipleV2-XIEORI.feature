...
#    When I click continue on "C285_Multiple_Check These Bank Details Are Correct Page v2"
    ...
    And I should see the following details
      | Basis of claim | Import date      | Contact details             | Importer email       | Contact address                                   | Name on the account | Importer telephone | Importer name    | Account number   | Declarant name     | Importer address                                 | Additional claim details | Declarant address                                 | Total   | Method of payment |Duties paid | Sort code      | First MRN          | Second MRN         | Uploaded                        | 20XIDCAAAAAAAAAAA1 | 10XIDCAAAAAAAAAAA1 |
