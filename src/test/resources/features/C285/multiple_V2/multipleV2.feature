...
Feature: C285 Multiple
  ...
  Scenario: happy path - with no bank details (user is both importer and declarant)
    ...
    Then I am presented with the "C285_Multiple_Check Answers Accept Send Page v2"
    And I should see the following details
      | This is the basis behind the claim | Import date    | Contact details                                        | Importer email          | Contact address                             | Name on the account | Importer telephone | Importer name   | Account number   | Declarant name         | Importer address                            | This is the reason for the claim | Declarant address                                         | Total   | Method of payment |Local Reference Number (LRN)| Duties paid | Sort code      | First MRN          | Second MRN         | 20AAAAAAAAAAAAAAA1 | 60AAAAAAAAAAAAAAA1 | Uploaded                        |
...
#    When the "overpayments v2" feature is "enabled"
  ...
  Scenario: happy path with new payee type page - user with only importer bank details and selects declarant user - CMA not eligible
    ...
    Then I am presented with the "C285_Multiple_Check Answers Accept Send Page v2"
    And I should see the following details
      | This is the basis behind the claim | Import date    | Contact details                                        | Importer email          | Contact address                             | Name on the account | Importer telephone | Importer name   | Account number   | Declarant name         | Importer address                            | This is the reason for the claim | Declarant address                                         | Total   | Method of payment |Local Reference Number (LRN)| Duties paid | Sort code      | First MRN          | Second MRN         | 20AAAAAAAAAAAAAAA1 | 60AAAAAAAAAAAAAAA5 | Uploaded                        |
