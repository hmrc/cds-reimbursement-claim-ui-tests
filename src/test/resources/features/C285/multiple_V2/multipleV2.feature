...
Feature: C285 Multiple
  ...
  Scenario: happy path - check importer/declarant eori pages
    ...
    When I enter "01AFRAAAAAAAAAAA02" on "C285_Multiple_Enter Movement Reference Number Page v2"
    ...
    When I enter "02AFRAAAAAAAAAAA02" on "C285_Multiple_Enter Movement Reference Number 2 Page v2"
...
#      | Outward processing relief          | £0.00    | 12 February 2021 | TestUser,someemail@mail.com | automation@gmail.com | 12 Skybricks Road,Coventry,CV3 6EA | CDS E2E To E2E Bank | +4420723934397     | IT Solutions LTD | Ending with 5678 | Foxpro Central LTD | Yes                                             | 19 Bricks Road,Newcastle,NE12 5BT,United Kingdom | under 500 characters             | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | £788.00 | £828.00     | Ending with 44 | 10AAAAAAAAAAAAAAA2 | 20AAAAAAAAAAAAAAA2 | £379.00            | £409.00            |
  ...
  Scenario: happy path - don't check importer/declarant eori pages
    ...
    And I click continue on "C285_Choose How Many Mrns Page v2"
    Then I am presented with the "C285_Multiple_Enter Movement Reference Number Page v2"
    When I enter "01AFRAAAAAAAAAAA01" on "C285_Multiple_Enter Movement Reference Number Page v2"
    And I click continue on "C285_Multiple_Enter Movement Reference Number Page v2"
    Then I am presented with the "C285_Multiple_Check Declaration Details Page v2"
    And I select radio button "yes" on "C285_Multiple_Check Declaration Details Page v2"
    And I click continue on "C285_Multiple_Check Declaration Details Page v2"
    Then I am presented with the "C285_Multiple_Enter Movement Reference Number 2 Page v2"
    When I enter "02AFRAAAAAAAAAAA01" on "C285_Multiple_Enter Movement Reference Number 2 Page v2"
    And I click continue on "C285_Multiple_Enter Movement Reference Number 2 Page v2"
    Then I am presented with the "C285_Multiple_Check Movement Reference Numbers Page v2"
    When I select radio button "No" on "C285_Multiple_Check Movement Reference Numbers Page v2"
    And I click continue on "C285_Multiple_Check Movement Reference Numbers Page v2"
  ...
  Scenario: error scenario - second mrn not linked to importer/declarant eori
    ...
    And I click continue on "C285_Multiple_Check Declaration Details Page v2"
    Then I am presented with the "C285_Multiple_Enter Movement Reference Number 2 Page v2"
    When I enter "01AFRAAAAAAAAAAA01" on "C285_Multiple_Enter Movement Reference Number 2 Page v2"
    And I click continue on "C285_Multiple_Enter Movement Reference Number 2 Page v2"
    Then I am presented with the "C285_Multiple_Enter Movement Reference Number 2 Page v2" error page
  ...
  Scenario: happy path with many MRNs and duties
    ...
    When I enter "10XO1XXXXXXXXXXX01" on "C285_Multiple_Enter Movement Reference Number 3 Page v2"
    ...
    When I enter "10YO2YYYYYYYYYYY01" on "C285_Multiple_Enter Movement Reference Number 4 Page v2"
    ...
    When I enter "10ZO3ZZZZZZZZZZZ01" on "C285_Multiple_Enter Movement Reference Number 5 Page v2"
