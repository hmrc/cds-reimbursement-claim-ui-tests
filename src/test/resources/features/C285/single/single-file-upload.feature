Feature: MRN file upload (bulk enabled, entry disabled)
  ...
  Scenario: happy path (mrn) - upload 3 files
    ...
    # upload file 2
    When I select radio button "Yes" on "Single_Supporting Evidence Check Your Answers 1 Page"
    ...
    And I click continue on "Single_Supporting Evidence Select Supporting Evidence Type Page"
    Then I am presented with the "Single_Supporting Evidence Check Your Answers 2 Page"
    # upload file 3
    When I select radio button "Yes" on "Single_Supporting Evidence Check Your Answers 2 Page"
    And I click continue on "Single_Supporting Evidence Check Your Answers 2 Page"
    Then I am presented with the "Single_Supporting Evidence Upload Supporting Evidence Page"
    When I upload a "document.pdf" file on "Single_Supporting Evidence Upload Supporting Evidence Page"
    And I click continue on "Single_Supporting Evidence Upload Supporting Evidence Page"
    And I click continue if I'm on "Single_Supporting Evidence Scan Progress Page"
    ...
    And I click continue on "Single_Supporting Evidence Select Supporting Evidence Type Page"
    Then I am presented with the "Single_Supporting Evidence Check Your Answers 3 Page"
    # continue journey
    When I select radio button "No" on "Single_Supporting Evidence Check Your Answers 3 Page"
    And I click continue on "Single_Supporting Evidence Check Your Answers 3 Page"
