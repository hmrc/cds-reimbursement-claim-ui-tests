...
#    When the "overpayments v2" feature is "enabled"
    ...
    And I should see the following details
      | This is the basis behind the claim | Import date    | Contact details                                        | Importer email          | Uploaded                        | Contact address                             | Name on the account | Importer telephone | Importer name   | Account number   | Declarant name         |  Importer address                            | This is the reason for the claim | Declarant address                                         | EU Duty | Total   | Method                | Method of payment |MRN                |Local Reference Number (LRN)|  Duties paid | Sort code      |
...
#    When the "overpayments v2" feature is "enabled"
    ...
    Then I am presented with the "C285_Single_Check Answers Accept Send Page v2"
    And I should see the following details
      | This is the basis behind the claim        | Import date    | Contact details                                        | Account number| Sort code| Name on the account|Importer email          | Uploaded                        | Contact address                             | Importer telephone | Importer name   | Declarant name         | Importer address                            | This is the reason for the claim | Declarant address                                         | EU Duty | Total   | MRN                |Local Reference Number (LRN)| Duties paid | Method                         | Method of payment |
