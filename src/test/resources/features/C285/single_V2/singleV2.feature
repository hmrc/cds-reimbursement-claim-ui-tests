...
#    And I select radio button "No" on "UCDF_Choose File Other Page"
    ...
    And I should see the following details
      | This is the basis behind the claim | Import date    | Contact details                                        | Importer email          | Uploaded                        | Contact address                             | Name on the account | Importer telephone | Importer name   | Account number   | Declarant name         |Payee|  Importer address                            | This is the reason for the claim | Declarant address                                         | EU Duty | Total   | Method                | Method of payment |MRN                |Local Reference Number (LRN)|  Duties paid | Sort code      |
      | End use relief                     | 13 August 2019 | Mr John Smith,someemail@mail.com,01234567890 | enquiries@swftgoods.com | document.pdf,Other documents | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Consignee Goods Ltd | 0207 678 3243      | Swift Goods Ltd | Ending with 8523 | Fred Bloggs and Co Ltd |Importer |  14 Briar Lane,London,Pimlico,United Kingdom | under 500 characters             | 10 Rillington Place,London,Pimlico,W11 1RH,United Kingdom | £788.00 | £788.00 | Bank account transfer | Immediate Payment |60AAAAAAAAAAAAAAA5 |XFGLKJDSE5GDPOIJEW985T          | £828.00     | Ending with 41 |
...
#    And I select radio button "No" on "UCDF_Choose File Other Page"
    ...
    Then I am presented with the "C285_Single_Check Answers Accept Send Page v2"
    And I should see the following details
      | This is the basis behind the claim        | Import date    | Contact details                                        | Account number| Sort code| Name on the account|Importer email          | Uploaded                        | Contact address                             | Importer telephone | Importer name   | Declarant name         |Payee| Importer address                            | This is the reason for the claim | Declarant address                                         | EU Duty | Total   | MRN                |Local Reference Number (LRN)| Duties paid | Method                         | Method of payment |
      | Duplicate Movement Reference Number (MRN) | 13 August 2019 | Mr John Smith,someemail@mail.com,01234567890 | Ending with 8523|Ending with 41| Consignee Goods Ltd    | enquiries@swftgoods.com | document.pdf,Other documents | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | 0207 678 3243      | Swift Goods Ltd | Fred Bloggs and Co Ltd |Importer| 14 Briar Lane,London,Pimlico,United Kingdom | under 500 characters             | 10 Rillington Place,London,Pimlico,W11 1RH,United Kingdom | £580.00 | £580.00 | 60AAAAAAAAAAAAAAA5 |XFGLKJDSE5GDPOIJEW985T| £828.00     | Current Month Adjustment (CMA) | Immediate Payment |
    When I click continue on "C285_Single_Check Answers Accept Send Page v2"
    Then I am presented with the "C285_Single_Claim Submitted Page v2"
...
#    And I select radio button "No" on "UCDF_Choose File Other Page"
    ...
    And I should see the following details
      | This is the basis behind the claim | Import date    | Contact details                                        | Importer email          | Uploaded                        | Contact address                             | Name on the account | Importer telephone | Importer name   | Account number   | Declarant name         |Payee|  Importer address                            | This is the reason for the claim | Declarant address                                         | EU Duty | Total   | Method                | Method of payment |MRN                |Local Reference Number (LRN)| Duties paid | Sort code      |
      | End use relief                     | 13 August 2019 | Mr John Smith,someemail@mail.com,01234567890 | enquiries@swftgoods.com | document.pdf,Other documents | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Mr John Smith       | 0207 678 3243      | Swift Goods Ltd | Ending with 1001 | Fred Bloggs and Co Ltd |Importer |  14 Briar Lane,London,Pimlico,United Kingdom | under 500 characters             | 10 Rillington Place,London,Pimlico,W11 1RH,United Kingdom | £208.00 | £208.00 | Bank account transfer | Immediate Payment |60AAAAAAAAAAAAAAA1 |XFGLKJDSE5GDPOIJEW985T          | £828.00     | Ending with 56 |
    When I click continue on "C285_Single_Check Answers Accept Send Page v2"
    Then I am presented with the "C285_Single_Claim Submitted Page v2"
