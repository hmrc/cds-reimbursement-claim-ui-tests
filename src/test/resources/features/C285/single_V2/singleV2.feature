...
#    When I click continue on "C285_Single_Check These Bank Details Are Correct Page v2"
    ...
    Then I am presented with the "C285_Single_Check Answers Accept Send Page v2"
    And I should see the following details
      | Basis of claim        | Import date    | Contact details                                        | Account number| Sort code| Name on the account|Importer email          | Uploaded                        | Contact address                             | Importer telephone | Importer name   | Declarant name         |Duplicate MRN|Payee| Importer address                            | Additional claim details | Declarant address                                         | A85 - Provisional Anti-Dumping Duty |A90 - Definitive Countervailing Duty|A95 - Provisional Countervailing Duty| Total   | MRN                |Local Reference Number (LRN)| Duties paid | Method                         | Method of payment |
      | Duplicate Movement Reference Number (MRN) | 13 August 2019 | Mr John Smith,someemail@mail.com,01234567890 | Ending with 1001|Ending with 56| Mr John Smith    | enquiries@swftgoods.com | document.pdf,Commercial invoice | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | 0207 678 3243      | Swift Goods Ltd | Fred Bloggs and Co Ltd |20AAAAAAAAAAAAAAA1|Importer| 14 Briar Lane,London,Pimlico,United Kingdom | under 500 characters             | 10 Rillington Place,London,Pimlico,W11 1RH,United Kingdom | £10.00 | £10.00                          |£10.00                              | £30.00 | 60AAAAAAAAAAAAAAA5 |XFGLKJDSE5GDPOIJEW985T| £828.00     | Current Month Adjustment (CMA) | Immediate Payment |
    When I click continue on "C285_Single_Check Answers Accept Send Page v2"
    Then I am presented with the "C285_Single_Claim Submitted Page v2"
...
#    When I click continue on "C285_Single_Check These Bank Details Are Correct Page v2"
    ...
    Then I am presented with the "C285_Single_Check Answers Accept Send Page v2"
    And I should see the following details
      | Basis of claim | Import date    | Contact details                                        | Importer email          | Uploaded                        | Contact address                             | Name on the account | Importer telephone | Importer name   | Account number   | Declarant name         |Payee|  Importer address                            | Additional claim details | Declarant address                                         | A80 - Definitive Anti-Dumping Duty | Total   | Method                | Method of payment |MRN                |Local Reference Number (LRN)| Duties paid | Sort code      |
