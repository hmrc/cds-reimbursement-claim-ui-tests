...
#    And I click continue on "UDF_Summary Page"
    Then I am presented with the "C285_Single_Check Answers Accept Send Page v2"
    And I should see the following details
      | Basis of claim        | Import date      | Contact details                  | Importer email       | Uploaded                        | Contact address                                   | Importer telephone | Importer name    |Account number| Sort code| Name on the account| Declarant name     |Duplicate MRN|Payee|  Importer address                                 | Additional claim information | Declarant address                                 | A85 - Provisional Anti-Dumping Duty |A90 - Definitive Countervailing Duty| Total   | MRN                |A95 - Provisional Countervailing Duty| Duties paid | Method                         | Method of payment |
      | Duplicate Movement Reference Number (MRN) | 12 February 2021 | Mr John Smith,someemail@mail.com,01234567890 | automation@gmail.com | document.pdf,Commercial invoice | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | +4420723934397     | IT Solutions LTD |Ending with 1001|Ending with 56| Mr John Smith |Foxpro Central LTD |20AAAAAAAAAAAAAAA1|Importer|  19 Bricks Road,Newcastle,NE12 5BT,United Kingdom | under 500 characters             | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | £10.00 | £10.00                | £30.00 | 10XICAAAAAAAAAAAA1 | £10.00     | £828.00                             | Current Month Adjustment (CMA) | Immediate Payment |
    When I click continue on "C285_Single_Check Answers Accept Send Page v2"
    Then I am presented with the "C285_Single_Claim Submitted Page v2"
