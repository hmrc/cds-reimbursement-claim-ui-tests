...
#    And I click continue on "UDF_Summary Page"
    Then I am presented with the "C285_Single_Check Answers Accept Send Page v2"
    And I should see the following details
      | Basis of claim        | Import date      | Contact details                  | Importer email       | Uploaded                        | Contact address                                   | Importer telephone | Importer name    |Account number| Sort code| Name on the account| Declarant name     |Duplicate MRN|Payee|  Importer address                                 | Additional claim details | Declarant address                                 | A85 - Provisional Anti-Dumping Duty |A90 - Definitive Countervailing Duty| Total   | MRN                |A95 - Provisional Countervailing Duty| Duties paid | Method                         | Method of payment |
