...
#    When I click continue on "C285_Single_Check These Bank Details Are Correct Page v2"
    ...
    And I should see the following details
      | Basis of claim        | Import date                                              | Uploaded                                              | Name on the account    | Account number    |Duplicate MRN|Payee| Additional claim details | A80 - Definitive Anti-Dumping Duty |A85 - Provisional Anti-Dumping Duty|A90 - Definitive Countervailing Duty|A95 - Provisional Countervailing Duty| Total   | Method                | Method of payment |MRN                | Duties paid | Sort code      |
      | Duplicate Movement Reference Number (MRN) | 12 February 2021  | document.pdf,Commercial invoice  | Mr John Smith | 11001001 |20AAAAAAAAAAAAAAA1|Importer    | under 500 characters             | £10.00 | £10.00                                   | £10.00                             | £10.00                              | £40.00 | Bank account transfer | Immediate Payment |10AAAAAAAAAAAAAAA1 | £828.00     | 123456 |
...
#    When I click continue on "C285_Single_Check These Bank Details Are Correct Page v2"
    ...
    And I should see the following details
      ...
      | Incorrect excise value             | 12 February 2021 | automation@gmail.com | document.pdf,Commercial invoice | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Mr John Smith | 11001001 |Importer    | under 500 characters             | £10.00     |£10.00                                                                                                                                                   |£10.00                     | £30.00 | 10AAAAAAAAAAAAAAA3 | £828.00     | 123456 | Bank account transfer | Immediate Payment |
    When I click continue on "C285_Single_Check Answers Accept Send Page v2"
    Then I am presented with the "C285_Single_Claim Submitted Page v2"
  ...
  Scenario: happy path - excise journey but excise not selected
    ...
    And I should see the following details
      ...
      | Returned goods relief (RGR)        | 12 February 2021 | automation@gmail.com | document.pdf,Commercial invoice | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Mr John Smith   | 11001001  | under 500 characters           | £208.00 | £580.00     | £788.00 | Bank account transfer | Immediate Payment |10AAAAAAAAAAAAAAA3 | £828.00     | 123456 |
    When I click continue on "C285_Single_Check Answers Accept Send Page v2"
    Then I am presented with the "C285_Single_Claim Submitted Page v2"