...
#    And I select radio button "No" on "UCDF_Choose File Other Page"
    ...
    And I should see the following details
      | This is the basis behind the claim        | Import date      | Contact details                                      | Importer email       | Uploaded                        | Contact address                                  | Name on the account | Importer telephone | Importer name    | Account number   | Declarant name     |Payee| Importer address                                 | This is the reason for the claim | Declarant address                                 | EU Duty | Total   | Method                | Method of payment |MRN                | Duties paid | Sort code      |
      | Duplicate Movement Reference Number (MRN) | 12 February 2021 | Mr John Smith,someemail@mail.com,01234567890 | automation@gmail.com | document.pdf,Other documents | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | CDS E2E To E2E Bank | +4420723934397     | IT Solutions LTD | Ending with 5678 | Foxpro Central LTD |Importer    | 19 Bricks Road,Newcastle,NE12 5BT,United Kingdom | under 500 characters             | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | £788.00 | £788.00 | Bank account transfer | Immediate Payment |10AAAAAAAAAAAAAAA1 | £828.00     | Ending with 44 |
...
#    And I select radio button "No" on "UCDF_Choose File Other Page"
    ...
    Then I am presented with the "C285_Single_Check Answers Accept Send Page v2"
    And I should see the following details
      | This is the basis behind the claim | Import date      | Contact details                                      | Importer email       | Uploaded                        | Contact address                                  | Name on the account | Importer telephone | Importer name    | Account number   | Declarant name     |Payee|  Importer address                                 | This is the reason for the claim | Declarant address                                 | Excise Duty | Total   | MRN                | Duties paid | Sort code      | Method                | Method of payment |
      | Incorrect excise value             | 12 February 2021 | Mr John Smith,someemail@mail.com,01234567890 | automation@gmail.com | document.pdf,Other documents | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | CDS E2E To E2E Bank | +4420723934397     | IT Solutions LTD | Ending with 5678 | Foxpro Central LTD |Importer    |  19 Bricks Road,Newcastle,NE12 5BT,United Kingdom | under 500 characters             | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | £580.00     | £580.00 | 10AAAAAAAAAAAAAAA3 | £828.00     | Ending with 44 | Bank account transfer | Immediate Payment |
    When I click continue on "C285_Single_Check Answers Accept Send Page v2"
    Then I am presented with the "C285_Single_Claim Submitted Page v2"
