...
#    When I click continue on "C285_Single_Check These Bank Details Are Correct Page v2"
    ...
    And I should see the following details
      | Basis of claim        | Import date  |   Contact details  | Uploaded                                              | Name on the account    | Account number    |Duplicate MRN|Payee| Additional claim details | A80 - Definitive Anti-Dumping Duty |A85 - Provisional Anti-Dumping Duty|A90 - Definitive Countervailing Duty|A95 - Provisional Countervailing Duty| Total   | Method                | Method of payment |MRN                | Duties paid | Sort code      |
      | Duplicate Movement Reference Number (MRN) | 12 February 2021  | Mr John Smith,someemail@mail.com,01234567890 | document.pdf,Commercial invoice  | Mr John Smith | 11001001 |20AAAAAAAAAAAAAAA1 |Importer    | under 500 characters             | £10.00 | £10.00                                   | £10.00                             | £10.00                              | £40.00 | Bank account transfer | Immediate Payment |10AAAAAAAAAAAAAAA1 | £828.00     | 123456 |
