...
#    When I click continue on "C285_Single_Check These Bank Details Are Correct Page v2"
    ...
    And I should see the following details
      | Basis of claim        | Import date      | Contact details                                      | Importer email       | Uploaded                        | Contact address                                  | Name on the account | Importer telephone | Importer name    | Account number   | Declarant name     |Duplicate MRN|Payee| Importer address                                 | Additional claim information | Declarant address                                 | A80 - Definitive Anti-Dumping Duty |A85 - Provisional Anti-Dumping Duty|A90 - Definitive Countervailing Duty|A95 - Provisional Countervailing Duty| Total   | Method                | Method of payment |MRN                | Duties paid | Sort code      |
