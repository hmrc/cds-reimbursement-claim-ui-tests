...
Feature: C285 Single V2 with subsidy check
  ...
  @test @subsidy
  Scenario: unhappy path - Subsidy feature - v2 enabled
  ...
  @test
  Scenario: happy path single subsidy journey
    Given I navigate to the "Auth Login Stub Page"
    And I enter redirectURL on "Auth Login Stub Page"
    And I enter Enrollment Key "HMRC-CUS-ORG", ID Name "EORINumber" and ID Value "GB000000000000001" on "Auth Login Stub Page"
    And I click continue on "Auth Login Stub Page"
    ...
    And I click continue on "Select Claim Type Page"
    When the "block subsidies" feature is "enabled"
    When the "subsidies for overpayments" feature is "enabled"
    Then I am presented with the "C285_Choose How Many Mrns Page v2"
    And I select radio button "individual" on "C285_Choose How Many Mrns Page v2"
    And I click continue on "C285_Choose How Many Mrns Page v2"
    Then I am presented with the "C285_Single_Enter Movement Reference Number Page v2"
    ...
    And I should see the following details
      | This is the basis behind the claim        | Method of payment | Import date      | Contact details                                      | Importer email       | Uploaded                        | Contact address                                   | Importer telephone | Importer name    | Declarant name     | Were your goods imported into Northern Ireland? | Importer address                                 | This is the reason for the claim | Declarant address                                 | EU Duty | Total   | Method                | MRN                | Duties paid |
      | End use relief                            | Subsidy           |12 February 2021 | Online Sales LTD,automation@gmail.com,+4420723934397 | automation@gmail.com | document.pdf,Commercial invoice | 19 Bricks Road,Newcastle,NE12 5BT,United Kingdom  | +4420723934397     | IT Solutions LTD  | Foxpro Central LTD | Yes                                             | 19 Bricks Road,Newcastle,NE12 5BT,United Kingdom | under 500 characters             | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | £788.00 | £788.00 | Subsidy allocation    | 00AA006AAAAAAAAA01 | £828.00     |
  ...
  @test
  Scenario: happy path with no bank details page (when the importer and declarant EORI are different) - Choose payee type page
    Given I navigate to the "Auth Login Stub Page"
    And I enter redirectURL on "Auth Login Stub Page"
    And I enter Enrollment Key "HMRC-CUS-ORG", ID Name "EORINumber" and ID Value "GB000000000000001" on "Auth Login Stub Page"
    And I click continue on "Auth Login Stub Page"
    ...
    And I click continue on "C285_Choose How Many Mrns Page v2"
    Then I am presented with the "C285_Single_Enter Movement Reference Number Page v2"
    When I enter "60DDDDDDDDDDDDDDD4" on "C285_Single_Enter Movement Reference Number Page v2"
    And I click continue on "C285_Single_Enter Movement Reference Number Page v2"
    Then I am presented with the "C285_Single_Check Declaration Details Page v2"
    And I select radio button "yes" on "C285_Single_Check Declaration Details Page v2"
    And I click continue on "C285_Single_Check Declaration Details Page v2"
  ...
  @test
  Scenario: happy path with no bank details (when the importer and declarant EORI are same) - skip new payee type page
    Given I navigate to the "Auth Login Stub Page"
    And I enter redirectURL on "Auth Login Stub Page"
    And I enter Enrollment Key "HMRC-CUS-ORG", ID Name "EORINumber" and ID Value "GB000000000000001" on "Auth Login Stub Page"
    And I click continue on "Auth Login Stub Page"
    ...
    And I click continue on "C285_Choose How Many Mrns Page v2"
    Then I am presented with the "C285_Single_Enter Movement Reference Number Page v2"
    When I enter "60DDDDDDDDDDDDDDD1" on "C285_Single_Enter Movement Reference Number Page v2"
    And I click continue on "C285_Single_Enter Movement Reference Number Page v2"
    Then I am presented with the "C285_Single_Check Declaration Details Page v2"
    And I select radio button "yes" on "C285_Single_Check Declaration Details Page v2"
    And I click continue on "C285_Single_Check Declaration Details Page v2"
  ...
  @test
  Scenario: happy path with bank details (only importer bank details)
    Given I navigate to the "Auth Login Stub Page"
    And I enter redirectURL on "Auth Login Stub Page"
    And I enter Enrollment Key "HMRC-CUS-ORG", ID Name "EORINumber" and ID Value "GB000000000000001" on "Auth Login Stub Page"
    And I click continue on "Auth Login Stub Page"
    ...
    And I click continue on "C285_Choose How Many Mrns Page v2"
    Then I am presented with the "C285_Single_Enter Movement Reference Number Page v2"
    When I enter "60DDDDDDDDDDDDDDD8" on "C285_Single_Enter Movement Reference Number Page v2"
    And I click continue on "C285_Single_Enter Movement Reference Number Page v2"
    Then I am presented with the "C285_Single_Check Declaration Details Page v2"
    And I select radio button "yes" on "C285_Single_Check Declaration Details Page v2"
    And I click continue on "C285_Single_Check Declaration Details Page v2"
    ...
    And I should see the following details
      | This is the basis behind the claim        | Method of payment | Import date      | Contact details                                      | Importer email          | Uploaded                        | Contact address                                            | Importer telephone | Importer name    | Declarant name         | Were your goods imported into Northern Ireland? | Importer address                                 | This is the reason for the claim | Declarant address                                         | EU Duty | Total   | Method                | MRN                | Duties paid |
      | End use relief                            | Subsidy           | 13 August 2019   | Angela Smith,fred@bloggs.com,0270 112 3476           | enquiries@swftgoods.com | document.pdf,Commercial invoice | 10 Rillington Place,London,Pimlico,W11 1RH,United Kingdom  | 0207 678 3243      | Swift Goods Ltd  | Fred Bloggs and Co Ltd | Yes                                             | 14 Briar Lane,London,Pimlico,United Kingdom      | under 500 characters             | 10 Rillington Place,London,Pimlico,W11 1RH,United Kingdom | £788.00 | £788.00 | Subsidy allocation    | 60DDDDDDDDDDDDDDD8 | £828.00     |
    And I click continue on "C285_Single_Check Answers Accept Send Page v2"
    Then I am presented with the "C285_Single_Claim Submitted Page v2"


  @test
  Scenario: error scenario for choose payee type
    Given I navigate to the "Auth Login Stub Page"
    And I enter redirectURL on "Auth Login Stub Page"
    And I enter Enrollment Key "HMRC-CUS-ORG", ID Name "EORINumber" and ID Value "GB000000000000001" on "Auth Login Stub Page"
    And I click continue on "Auth Login Stub Page"
