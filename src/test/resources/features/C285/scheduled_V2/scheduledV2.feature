...
Feature: C285 Scheduled
  ...
  Scenario: happy path - check importer/declarant eori pages
    ...
    Then I am presented with the "C285_Scheduled_Select Duties DutyType Duty Page v2" "Excise Duty-Beer 407"
    When I enter "10,5" on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    And I click continue on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    Then I am presented with the "C285_Scheduled_Select Duties DutyType Duty Page v2" "Excise Duty-Beer 447"
    When I enter "10,5" on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    And I click continue on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    ...
    Then I am presented with the "C285_Scheduled_Select Duties DutyType Duty Page v2" "Excise Duty-Wine 411"
    When I enter "10,5" on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    And I click continue on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    Then I am presented with the "C285_Scheduled_Select Duties DutyType Duty Page v2" "Excise Duty-Wine 415"
    When I enter "10,5" on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    And I click continue on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    ...
    Then I am presented with the "C285_Scheduled_Select Duties DutyType Duty Page v2" "Excise Duty-Made-wine 421"
    When I enter "10,5" on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    And I click continue on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    Then I am presented with the "C285_Scheduled_Select Duties DutyType Duty Page v2" "Excise Duty-Made-wine 429"
    When I enter "10,5" on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    And I click continue on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    ...
    Then I am presented with the "C285_Scheduled_Select Duties DutyType Duty Page v2" "Excise Duty-Miscellaneous road fuels 591"
    When I enter "10,5" on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    And I click continue on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    Then I am presented with the "C285_Scheduled_Select Duties DutyType Duty Page v2" "Excise Duty-Miscellaneous road fuels 592"
    When I enter "10,5" on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    And I click continue on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    ...
    Then I am presented with the "C285_Scheduled_Select Duties DutyType Duty Page v2" "Excise Duty-Tobacco products 611"
    When I enter "10,5" on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    And I click continue on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    Then I am presented with the "C285_Scheduled_Select Duties DutyType Duty Page v2" "Excise Duty-Tobacco products 633"
    When I enter "10,5" on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    And I click continue on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    ...
    Then I am presented with the "C285_Scheduled_Select Duties DutyType Duty Page v2" "Excise Duty-Climate Change Levy 99A"
    When I enter "10,5" on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    And I click continue on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    Then I am presented with the "C285_Scheduled_Select Duties DutyType Duty Page v2" "Excise Duty-Climate Change Levy 99D"
    When I enter "10,5" on "C285_Scheduled_Select Duties DutyType Duty Page v2"
    And I click continue on "C285_Scheduled_Select Duties DutyType Duty Page v2"
...
#    And I click continue on "C285_Scheduled_Check These Bank Details Are Correct Page v2"
    ...
    And I should see the following details
      | Basis of claim | Import date      | Contact details             | Importer email       | Uploaded                        | Contact address                                   | Name on the account | Importer telephone | Importer name    | Account number   | Declarant name     | Importer address                                 | Additional claim information | Declarant address                                 | EU Duty | UK Duty | Excise Duty | Total  | Method of payment |Duties paid | Sort code      | First MRN          | Scheduled document |
      | Outward processing relief          | 12 February 2021 | Mr John Smith,someemail@mail.com,01234567890 | automation@gmail.com | document.pdf,Commercial invoice | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Mr John Smith | +4420723934397     | IT Solutions LTD | Ending with 1001 | Foxpro Central LTD | 19 Bricks Road,Newcastle,NE12 5BT,United Kingdom | under 500 characters             | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | £10.00  | £10.00  | £60.00      | £80.00 | Immediate Payment |£828.00     | Ending with 56 | 10AAAAAAAAAAAAAAA2 | image.jpg          |
...
#    And I click continue on "C285_Scheduled_Check These Bank Details Are Correct Page v2"
    ...
    And I should see the following details
      | Basis of claim | Import date    | Contact details                                        | Importer email          | Uploaded                        | Contact address                             | Name on the account | Importer telephone | Importer name   | Account number   | Declarant name         | Importer address                            | Additional claim information | Declarant address                                         | EU Duty | UK Duty | Excise Duty | Total  | Method of payment |Local Reference Number (LRN)|Duties paid | Sort code      | First MRN          | Scheduled document |
      | Outward processing relief          | 13 August 2019 | Mr John Smith,someemail@mail.com,01234567890 | enquiries@swftgoods.com | document.pdf,Commercial invoice | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Mr John Smith       | 0207 678 3243      | Swift Goods Ltd | Ending with 1001 | Fred Bloggs and Co Ltd | 14 Briar Lane,London,Pimlico,United Kingdom | under 500 characters             | 10 Rillington Place,London,Pimlico,W11 1RH,United Kingdom | £10.00  | £10.00  | £60.00      | £80.00 | Immediate Payment |XFGLKJDSE5GDPOIJEW985T          |£828.00     | Ending with 56 | 60AAAAAAAAAAAAAAA5 | image.jpg          |
    And I click continue on "C285_Scheduled_Check Answers Accept Send Page v2"
    Then I am presented with the "C285_Scheduled_Claim Submitted Page v2"
