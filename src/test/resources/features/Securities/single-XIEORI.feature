...
Feature: Securities Single - XIEORI
  ...
  Scenario: happy path - check importer/declarant eori pages - with no Payment method
    ...
    And I should see the following details
      | Import MRN         | Reason for security deposit    | Import declaration              | Total security deposit value | Contact address                                           | Claim for DEF6543213 | Claim for DEF6543212 | Claim for DEF6543211 | Claim for DEF6543210 | B00 - Value Added Tax | Claim for ABC0123456 | Claim full amount | Total   | Duties selected                          | A00 - Customs Duty | Date security deposit made | Contact details             | Evidence supporting your claim           | Name on the account | Account number   | Sort code      |
      | 01XIDCAAAAAAAAAAA2 | Manual override of duty amount | document.pdf,Import declaration | £14,385.52                   | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Yes                  | No                   | No                   | No                   | £180.00               | Yes                   | No               | £270.00 | A00 - Customs Duty,B00 - Value Added Tax | £90.00            | 13 September 2019          | Mr John Smith,someemail@mail.com,01234567890 | image.jpg,Evidence supporting your claim | Swift Goods Ltd     | Ending with 8523 | Ending with 41 |
  ...
  Scenario: happy path - Securities without importer/declarant eori
    ...
    Then I am presented with the "Securities_Check Your Answers Page"
    And I should see the following details
      | Import MRN         | Reason for security deposit    | Export declaration           | Total security deposit value | Claim for DEF6543213 | Claim for DEF6543212 | Claim for DEF6543211 | Claim for DEF6543210 | B00 - Value Added Tax | Claim for ABC0123456 | Claim full amount | Total   | Duties selected                          | A00 - Customs Duty | Date security deposit made | Contact details                            | Import declaration              | Name on the account | Account number   | Sort code      | Contact address                                           |
      | 01XICAAAAAAAAAAAA1 | Inward Processing Relief (IPR) | image.jpg,Export declaration | £14,385.52                   | Yes                  | No                   | No                   | No                   | £200.00               | Yes                  | Yes               | £300.00 | A00 - Customs Duty,B00 - Value Added Tax | £100.00            | 13 September 2019          | Mr John Smith,someemail@mail.com,01234567890 | document.pdf,Import declaration | Swift Goods Ltd     | Ending with 8523 | Ending with 41 | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom |
    When I click continue on "Securities_Check Your Answers Page"
    Then I am presented with the "Securities_Claim Submitted Page"
  ...
  Scenario: Data validation check at Check your answers page - with Payment method as Bank account transfer
    ...
    Then I am presented with the "Securities_Check Your Answers Page"
    And I should see the following details
      | Import MRN         | Reason for security deposit | Import declaration              | Total security deposit value | Contact address                             | Name on the account | Claim for DEF6543213 | Claim for DEF6543212 | Claim for DEF6543211 | Claim for DEF6543210 | Account number   | B00 - Value Added Tax | Payment method        | Claim for ABC0123456 | Claim full amount | Total      | Duties selected                          | A00 - Customs Duty | Date security deposit made | Sort code      | Contact details                                        |
      | 10XIDAAAAAAAAAAAA1 | UKAP Entry Price            | document.pdf,Import declaration | £14,085.52                   | 14 Briar Lane,London,Pimlico,United Kingdom | Swift Goods Ltd     | No                   | No                   | No                   | No                   | Ending with 8523 | £8,085.52             | Bank account transfer | Yes                  | Yes               | £14,085.52 | A00 - Customs Duty,B00 - Value Added Tax | £6,000.00          | 13 September 2019          | Ending with 41 | Frank Sidebotham,enquiries@swftgoods.com,0207 678 3243 |
    When I click continue on "Securities_Check Your Answers Page"
    Then I am presented with the "Securities_Claim Submitted Page"
