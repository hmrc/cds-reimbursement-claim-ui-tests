...
Feature: Securities Single
  ...
  Scenario: happy path - check importer/declarant eori pages - with no Payment method
    ...
    Then I am presented with the "Securities_Confirm Full Repayment Security Id Page1" "ABC0123456"
    When I select radio button "No" on "Securities_Confirm Full Repayment Security Id Page1"
    And I click continue on "Securities_Confirm Full Repayment Security Id Page1"
    Then I am presented with the "Securities_Select Duties Security Id Page"
    When I select "A00,B00" on "Securities_Confirm Full Repayment Security Id Page1"
    And I click continue on "Securities_Confirm Full Repayment Security Id Page1"
