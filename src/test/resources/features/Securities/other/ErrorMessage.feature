...
Feature: Securities Journey Error Messages
  ...
  Scenario: To test the error messages for the Securities journey
    ...
    And The error summary title is "There is a problem" and the error message is "Select yes if details are correct"
    ...
    And The error summary title is "There is a problem" and the error message is "Choose the type of claim you want to submit"
    ...
    And The error summary title is "There is a problem" and the error message is "Enter a movement reference number"
    ...
    And The error summary title is "There is a problem" and the error message is "Choose if you are providing details for a business bank account or a personal bank account"
    ...
    And The error summary title is "There is a problem" and the error message is "Choose the type of file you are uploading"
    ...
    And The error summary title is "There is a problem" and the error message is "Select yes if you want to add a different type of supporting evidence"
