...
Feature: C285 - MRN - importer-person
  ...
  Scenario: User is a CDS Trader - happy path (mrn)
    ...
    Then I am presented with the "Enter Claim Page" "Smoking tobacco – other"
    When I enter "10" on "Enter Claim Page"
    And I click continue on "Enter Claim Page"
    Then I am presented with the "Enter Claim Page" "Gas supplied by a gas utility or any gas supplied in a gaseous state that is of a kind supplied by a gas utility Great Britain"
    When I enter "10" on "Enter Claim Page"
    And I click continue on "Enter Claim Page"
