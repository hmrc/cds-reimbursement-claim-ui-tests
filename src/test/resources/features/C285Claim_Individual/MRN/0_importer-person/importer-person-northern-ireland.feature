...
Feature: C285 - MRN - importer-person-northern-ireland
  ...
  Scenario: User is a CDS Trader - happy path (mrn)
    ...
    When I select radio button "Incorrect excise value (for imports into Northern Ireland only)" on "Choose Basis For Claim Page"
    ...
    Then I am presented with the "Enter Claim Page" "421 - Made-wine (sparkling), exceeding 8.5% vol. but not exceeding 15% vol."
    When I enter "10" on "Enter Claim Page"
    And I click continue on "Enter Claim Page"
    Then I am presented with the "Enter Claim Page" "623 - Smoking tobacco – other"
    When I enter "10" on "Enter Claim Page"
    And I click continue on "Enter Claim Page"
    Then I am presented with the "Enter Claim Page" "99C - Gas supplied by a gas utility or any gas supplied in a gaseous state that is of a kind supplied by a gas utility Great Britain"
    When I enter "10" on "Enter Claim Page"
    And I click continue on "Enter Claim Page"
