...
Feature: C285 - Entry Number - importer-person
  ...
  Scenario: User is a CDS Trader - happy path (entry number) - duplicate Entry Number
    ...
    Then I am presented with the "Entry_Check Eori Details Page"
    When I select radio button "yes" on "Entry_Check Eori Details Page"
    And I click continue on "Entry_Check Eori Details Page"
    Then I am presented with the "Entry_Enter Movement Reference Number Page"
    When I enter "000000001A00000001" on "Entry_Enter Movement Reference Number Page"
    And I click continue on "Entry_Enter Movement Reference Number Page"
    ...
    When I enter "000000002B00000002" on "Entry_Enter Movement Reference Number Page"
    And I click continue on "Entry_Enter Movement Reference Number Page"
  ...
  Scenario: User is a CDS Trader - happy path (entry number)
    ...
    When I select "A00,A20,A30,A35,A40,A45,B00,A50,A70,A80,A85,A90,A95,B05" on "Select Duties Page"
  ...
  Scenario: User is a CDS Trader - happy path (entry number) - change entry number
    ...
    Then I am presented with the "Check Claim Page"
    And I select radio button "yes" on "Check Claim Page"
    And I click continue on "Check Claim Page"
    Then I am presented with the "Enter Bank Account Details Page"
    When I enter "" on "Enter Bank Account Details Page"
    And I select checkbox on "Enter Bank Account Details Page"
    And I click continue on "Enter Bank Account Details Page"
