...
Feature: Bulk (bulk enabled, entry disabled)
  ...
  Scenario: test temp pages
    ...
    Then I am presented with the "Bulk_Check These Bank Details Are Correct Page"
    When I click continue on "Bulk_Check These Bank Details Are Correct Page"
    Then I am presented with the "Bulk_Supporting Evidence Upload Supporting Evidence Page"
    When I upload a "document.pdf" file on "Bulk_Supporting Evidence Upload Supporting Evidence Page"
    And I click continue on "Bulk_Supporting Evidence Upload Supporting Evidence Page"
    And I click continue if I'm on "Bulk_Supporting Evidence Upload Progress Page"
    When I select radio button "Commercial Invoice" on "Bulk_Supporting Evidence Select Supporting Evidence Type Page"
    And I click continue on "Bulk_Supporting Evidence Select Supporting Evidence Type Page"
  ...
  Scenario: happy path (mrn) - confirm ALF data works in journey
    ...
    When I select radio button "bulk" on "Select Number Of Claims Page"
    And I click continue on "Select Number Of Claims Page"
    Then I am presented with the "Bulk_Enter Movement Reference Number Page" and content "bulk-enabled,entry-disabled"
    When I enter "10AAAAAAAAAAAAAAA1" on "Bulk_Enter Movement Reference Number Page"
    And I click continue on "Bulk_Enter Movement Reference Number Page"
    Then I am presented with the "Bulk_Check Declaration Details Page" and content "10AAAAAAAAAAAAAAA1"
    And I select radio button "yes" on "Bulk_Check Declaration Details Page"
    ...
    And I click continue on "Bulk_Who Is The Declarant Page"
    Then I am presented with the "Bulk_Claimant Details Page"
    When I select radio button "no" on "Bulk_Claimant Details Page"
    And I click continue on "Bulk_Claimant Details Page"
    Then I am presented with the "Bulk_Claimant Details Page" and content "missing details"
    When I select radio button "yes" on "Bulk_Claimant Details Page"
    And I click continue on "Bulk_Claimant Details Page"
    Then I am presented with the "Bulk_Claimant Details Details Contact Page"
    And I enter "" on "Bulk_Claimant Details Details Contact Page"
    And I click continue on "Bulk_Claimant Details Details Contact Page"
    ...
    Then I am presented with the "Bulk_Claimant Details Page" and content "10AAAAAAAAAAAAAAA1 - change details"
    When I select radio button "yes" on "Bulk_Claimant Details Page"
    And I click continue on "Bulk_Claimant Details Page"
    Then I am presented with the "Bulk_Choose Basis For Claim Page"
    When I select radio button "OPR" on "Bulk_Choose Basis For Claim Page"
    And I click continue on "Bulk_Choose Basis For Claim Page"
    Then I am presented with the "Bulk_Enter Commodity Details Page"
    When I enter "under 500 characters" on "Bulk_Enter Commodity Details Page"
    And I click continue on "Bulk_Enter Commodity Details Page"
  ...
  Scenario: test temp pages - confirm ALF data works in journey (no contact details)
    ...
    And I click continue on "Select Number Of Claims Page"
    Then I am presented with the "Bulk_Enter Movement Reference Number Page"
    When I enter "10AAAAAAAAAAAAAAA6" on "Bulk_Enter Movement Reference Number Page"
    And I click continue on "Bulk_Enter Movement Reference Number Page"
    Then I am presented with the "Bulk_Check Declaration Details Page" and content "10AAAAAAAAAAAAAAA6"
    And I select radio button "yes" on "Bulk_Check Declaration Details Page"
    And I click continue on "Bulk_Check Declaration Details Page"
    Then I am presented with the "Bulk_Who Is The Declarant Page"
    When I select radio button "0" on "Bulk_Who Is The Declarant Page"
    And I click continue on "Bulk_Who Is The Declarant Page"
    Then I am presented with the "Bulk_Claimant Details Page" and content "10AAAAAAAAAAAAAAA6"
    When I select radio button "yes" on "Bulk_Claimant Details Page"
    And I click continue on "Bulk_Claimant Details Page"
    Then I am presented with the "Bulk_Claimant Details Details Contact Page"
    And I enter "" on "Bulk_Claimant Details Details Contact Page"
