...
Feature: Bulk (bulk enabled, entry disabled)
  ...
  Scenario: test temp pages
    ...
    When I select radio button "Duplicate MRN" on "Multiple_Choose Basis For Claim Page"
    And I click continue on "Multiple_Choose Basis For Claim Page"
    Then I am presented with the "Multiple_Enter Duplicate Movement Reference Number Page"
    When I enter "20AAAAAAAAAAAAAAA1" on "Multiple_Enter Duplicate Movement Reference Number Page"
    And I click continue on "Multiple_Enter Duplicate Movement Reference Number Page"
    Then I am presented with the "Multiple_Check Duplicate Declaration Details Page" and content "20AAAAAAAAAAAAAAA1"
    And I select radio button "yes" on "Multiple_Check Duplicate Declaration Details Page"
    And I click continue on "Multiple_Check Duplicate Declaration Details Page"
    ...
    Then I am presented with the "Multiple_Check Answers Accept Send Page" and content "check content"
  ...
  Scenario: happy path (mrn) - confirm ALF data works in journey
    ...
    And I click continue on "Multiple_Claimant Details Check Page"
    Then I am presented with the "Multiple_Claimant Details Check Page" and content "missing details"
    When I select radio button "yes" on "Multiple_Claimant Details Check Page"
    And I click continue on "Multiple_Claimant Details Check Page"
    Then I am presented with the "Multiple_Claimant Details Details Contact Page"
    And I enter "" on "Multiple_Claimant Details Details Contact Page"
    And I click continue on "Multiple_Claimant Details Details Contact Page"
