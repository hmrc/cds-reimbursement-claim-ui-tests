...
Feature: Bulk NI (bulk enabled, entry disabled)
  ...
  Scenario: test temp NI pages - NI enabled
    ...
    When I enter "60AAAAAAAAAAAAAAA1" on "Multiple_Enter Movement Reference Number 2 Page"
    ...
    When I select "421,623" on "Single_Select Duties Page"
    And I click continue on "Single_Select Duties Page"
    Then I am presented with the "Single_Enter Claim Page" "421 - Made-wine (sparkling), exceeding 8.5% vol. but not exceeding 15% vol." and content "£171.00"
    When I enter "10" on "Single_Enter Claim Page"
    And I click continue on "Single_Enter Claim Page"
    Then I am presented with the "Single_Enter Claim Page" "623 - Smoking tobacco – other" and content "£171.00"
    When I enter "10" on "Single_Enter Claim Page"
    And I click continue on "Single_Enter Claim Page"
