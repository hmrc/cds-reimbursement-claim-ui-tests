...
Feature: MRN (bulk enabled, entry disabled)
  ...
  Scenario: happy path (mrn) - confirm ALF data works in journey
    ...
    And I click continue on "Mrn_Who Is The Declarant Page"
    Then I am presented with the "Mrn_Claimant Details Page"
    When I select radio button "no" on "Mrn_Claimant Details Page"
    And I click continue on "Mrn_Claimant Details Page"
    Then I am presented with the "Mrn_Claimant Details Page" and content "missing details"
    When I select radio button "yes" on "Mrn_Claimant Details Page"
    And I click continue on "Mrn_Claimant Details Page"
    Then I am presented with the "Mrn_Claimant Details Details Contact Page"
    And I enter "" on "Mrn_Claimant Details Details Contact Page"
    And I click continue on "Mrn_Claimant Details Details Contact Page"
    ...
    Then I am presented with the "Mrn_Claimant Details Page" and content "10AAAAAAAAAAAAAAA1 - change details"
    When I select radio button "yes" on "Mrn_Claimant Details Page"
    And I click continue on "Mrn_Claimant Details Page"
    Then I am presented with the "Mrn_Choose Basis For Claim Page"
  ...
  Scenario: happy path (mrn) - confirm ALF data works in journey (no contact details)
    ...
    And I click continue on "ALF_Lookup Address Edit Page"
    And I click continue on "ALF_Lookup Address Confirm Page"
    Then I am presented with the "Mrn_Claimant Details Page" and content "10AAAAAAAAAAAAAAA6 - change details"
    When I select radio button "yes" on "Mrn_Claimant Details Page"
    And I click continue on "Mrn_Claimant Details Page"
    Then I am presented with the "Mrn_Choose Basis For Claim Page"
    When I select radio button "OPR" on "Mrn_Choose Basis For Claim Page"
