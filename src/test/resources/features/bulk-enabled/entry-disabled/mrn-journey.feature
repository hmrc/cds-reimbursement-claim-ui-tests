...
Feature: MRN (bulk enabled, entry disabled)
  ...
  Scenario: happy path (mrn) - duplicate mrn
    ...
    And I click continue on "Mrn_Claimant Details Check Page"
  ...
  Scenario: happy path (mrn) - duplicate mrn 2
    ...
    When I click continue on "Mrn_Check Claim Page"
    Then I am presented with the "Mrn_Check These Bank Details Are Correct Page"
    When I click "Change" on "Mrn_Check These Bank Details Are Correct Page"
    Then I am presented with the "Mrn_Bank Account Type Page"
    When I select radio button "Business bank account" on "Mrn_Bank Account Type Page"
    And I click continue on "Mrn_Bank Account Type Page"
  ...
  Scenario: happy path (mrn) - confirm ALF data works in journey
    ...
    And I click continue on "Mrn_Who Is The Declarant Page"
    Then I am presented with the "Mrn_Claimant Details Check Page"
    When I select radio button "no" on "Mrn_Claimant Details Check Page"
    And I click continue on "Mrn_Claimant Details Check Page"
    Then I am presented with the "Mrn_Claimant Details Add Page" and content "missing details"
    When I select radio button "yes" on "Mrn_Claimant Details Add Page"
    And I click continue on "Mrn_Claimant Details Add Page"
    Then I am presented with the "Mrn_Claimant Details Enter Contact Details Page"
    And I enter "" on "Mrn_Claimant Details Enter Contact Details Page"
    And I click continue on "Mrn_Claimant Details Enter Contact Details Page"
    ...
    Then I am presented with the "Mrn_Claimant Details Check Page" and content "10AAAAAAAAAAAAAAA1 - change details"
    When I select radio button "yes" on "Mrn_Claimant Details Check Page"
    And I click continue on "Mrn_Claimant Details Check Page"
    Then I am presented with the "Mrn_Choose Basis For Claim Page"
    When I select radio button "OPR" on "Mrn_Choose Basis For Claim Page"
    And I click continue on "Mrn_Choose Basis For Claim Page"
    Then I am presented with the "Mrn_Enter Commodity Details Page"
    When I enter "under 500 characters" on "Mrn_Enter Commodity Details Page"
    And I click continue on "Mrn_Enter Commodity Details Page"
  ...
  Scenario: happy path (mrn) - confirm ALF data works in journey (no contact details)
    ...
    And I click continue on "Select Number Of Claims Page"
    Then I am presented with the "Enter Movement Reference Number Page" and content "bulk-enabled,entry-disabled"
    When I enter "10AAAAAAAAAAAAAAA6" on "Enter Movement Reference Number Page"
    And I click continue on "Enter Movement Reference Number Page"
    Then I am presented with the "Mrn_Check Declaration Details Page" and content "10AAAAAAAAAAAAAAA6"
    And I select radio button "yes" on "Mrn_Check Declaration Details Page"
    And I click continue on "Mrn_Check Declaration Details Page"
    Then I am presented with the "Mrn_Who Is The Declarant Page"
    When I select radio button "0" on "Mrn_Who Is The Declarant Page"
    And I click continue on "Mrn_Who Is The Declarant Page"
    Then I am presented with the "Mrn_Claimant Details Check Page" and content "10AAAAAAAAAAAAAAA6"
    When I select radio button "yes" on "Mrn_Claimant Details Check Page"
    And I click continue on "Mrn_Claimant Details Check Page"
    Then I am presented with the "Mrn_Claimant Details Enter Contact Details Page"
    And I enter "" on "Mrn_Claimant Details Enter Contact Details Page"
    ...
    And I click continue on "ALF_Lookup Address Edit Page"
    And I click continue on "ALF_Lookup Address Confirm Page"
    Then I am presented with the "Mrn_Claimant Details Check Page" and content "10AAAAAAAAAAAAAAA6 - change details"
    When I select radio button "yes" on "Mrn_Claimant Details Check Page"
    And I click continue on "Mrn_Claimant Details Check Page"
    Then I am presented with the "Mrn_Choose Basis For Claim Page"
    When I select radio button "OPR" on "Mrn_Choose Basis For Claim Page"
  ...
  Scenario: happy path (mrn) - check importer/declarant eori pages
    ...
    When I enter "GB000000000000006" on "Mrn_Importer Eori Entry Page"
    And I click continue on "Mrn_Importer Eori Entry Page"
    Then I am presented with the "Mrn_Declarant Eori Entry Page"
    When I enter "GB000000000000006" on "Mrn_Declarant Eori Entry Page"
    And I click continue on "Mrn_Importer Eori Entry Page"
    Then I am presented with the "Mrn_Check Declaration Details Page" and content "10AAAAAAAAAAAAAAA6"
