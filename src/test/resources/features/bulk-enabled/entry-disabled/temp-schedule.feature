...
Feature: Scheduled (bulk enabled, entry disabled)
  ...
  Scenario: test temp pages
    ...
    When I click continue on "Scheduled_Check These Bank Details Are Correct Page"
    Then I am presented with the "Scheduled_Supporting Evidence Upload Supporting Evidence Page"
    When I upload a "document.pdf" file on "Scheduled_Supporting Evidence Upload Supporting Evidence Page"
