...
Feature: MRN Northern Ireland (bulk enabled, entry disabled)
  ...
  Scenario: happy path (mrn ni) - excise duty selected
    ...
    And I select radio button "yes" on "Mrn_Claim Northern Ireland Page"
    And I click continue on "Mrn_Claim Northern Ireland Page"
    Then I am presented with the "Mrn_Choose Basis For Claim Page" and content "10AAAAAAAAAAAAAAA3 - excise"
  ...
  Scenario: happy path (mrn ni) - excise journey but excise not selected
    ...
    And I select radio button "yes" on "Mrn_Claim Northern Ireland Page"
    And I click continue on "Mrn_Claim Northern Ireland Page"
    Then I am presented with the "Mrn_Choose Basis For Claim Page" and content "excise"
