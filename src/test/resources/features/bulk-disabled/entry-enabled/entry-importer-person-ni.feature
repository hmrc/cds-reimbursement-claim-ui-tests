...
Feature: C285 - Entry Number - importer-person - northern-ireland
  ...
  Scenario: User is a CDS Trader - happy path (entry number) - duplicate Entry Number
    ...
    And I enter Enrollment Key "HMRC-CUS-ORG", ID Name "EORINumber" and ID Value "GB000000000000003" on "Auth Login Stub Page"
    And I click continue on "Auth Login Stub Page"
    Then I am presented with the "Check Eori Details Page" and content "GB000000000000003,TestUser"
