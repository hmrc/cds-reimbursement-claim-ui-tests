...
Feature: MRN Northern Ireland (bulk disabled, entry disabled)
  ...
  Scenario: happy path (mrn ni) - excise duty selected
    ...
    And I click continue on "Enter Movement Reference Number Page"
    Then I am presented with the "Mrn_Check Declaration Details Page" and content "10AAAAAAAAAAAAAAA3"
    And I select radio button "yes" on "Mrn_Check Declaration Details Page"
    And I click continue on "Mrn_Check Declaration Details Page"
    Then I am presented with the "Mrn_Who Is The Declarant Page"
    When I select radio button "0" on "Mrn_Who Is The Declarant Page"
    ...
    And I select radio button "yes" on "Mrn_Claim Northern Ireland Page"
    And I click continue on "Mrn_Claim Northern Ireland Page"
    Then I am presented with the "Mrn_Choose Basis For Claim Page" and content "10AAAAAAAAAAAAAAA3"
    When I select radio button "Incorrect excise value - Northern Ireland claims only" on "Mrn_Choose Basis For Claim Page"
    And I click continue on "Mrn_Choose Basis For Claim Page"
    Then I am presented with the "Mrn_Enter Commodity Details Page"
    When I enter "under 500 characters" on "Mrn_Enter Commodity Details Page"
    And I click continue on "Mrn_Enter Commodity Details Page"
    Then I am presented with the "Mrn_Select Duties Page" and content "10AAAAAAAAAAAAAAA3 - excise"
    When I select "421,623,99C" on "Mrn_Select Duties Page"
    And I click continue on "Mrn_Select Duties Page"
    Then I am presented with the "Mrn_Enter Claim Page" "421 - Made-wine (sparkling), exceeding 8.5% vol. but not exceeding 15% vol." and content "£211.00"
    When I enter "10" on "Mrn_Enter Claim Page"
    And I click continue on "Mrn_Enter Claim Page"
    Then I am presented with the "Mrn_Enter Claim Page" "623 - Smoking tobacco – other" and content "£228.00"
    When I enter "10" on "Mrn_Enter Claim Page"
    And I click continue on "Mrn_Enter Claim Page"
    Then I am presented with the "Mrn_Enter Claim Page" "99C - Gas supplied by a gas utility or any gas supplied in a gaseous state that is of a kind supplied by a gas utility Great Britain" and content "£171.00"
    When I enter "10" on "Mrn_Enter Claim Page"
    And I click continue on "Mrn_Enter Claim Page"
    Then I am presented with the "Mrn_Check Claim Page" and content "excise"
    And I select radio button "yes" on "Mrn_Check Claim Page"
    When I click continue on "Mrn_Check Claim Page"
    Then I am presented with the "Mrn_Check These Bank Details Are Correct Page"
    When I click continue on "Mrn_Check These Bank Details Are Correct Page"
    ...
    Then I am presented with the "Mrn_Check Answers Accept Send Page"
    And I click continue on "Mrn_Check Answers Accept Send Page"
    Then I am presented with the "Mrn_Claim Submitted Page" and content "£30.00"
  ...
  Scenario: happy path (mrn ni) - excise journey but excise not selected
    ...
    And I click continue on "Mrn_Claim Northern Ireland Page"
    Then I am presented with the "Mrn_Choose Basis For Claim Page" and content "10AAAAAAAAAAAAAAA3"
    When I select radio button "RGR" on "Mrn_Choose Basis For Claim Page"
    And I click continue on "Mrn_Choose Basis For Claim Page"
    Then I am presented with the "Mrn_Enter Commodity Details Page"
    When I enter "under 500 characters" on "Mrn_Enter Commodity Details Page"
    And I click continue on "Mrn_Enter Commodity Details Page"
    Then I am presented with the "Mrn_Select Duties Page" and content "10AAAAAAAAAAAAAAA3"
    When I select "A80,421,623,99C" on "Mrn_Select Duties Page"
    And I click continue on "Mrn_Select Duties Page"
    Then I am presented with the "Mrn_Enter Claim Page" "A80 - Definitive Anti-Dumping Duty" and content "£218.00"
    When I enter "10" on "Mrn_Enter Claim Page"
    And I click continue on "Mrn_Enter Claim Page"
    ...
    When I enter "10" on "Mrn_Enter Claim Page"
    And I click continue on "Mrn_Enter Claim Page"
    Then I am presented with the "Mrn_Check Claim Page" and content "10AAAAAAAAAAAAAAA3"
    And I select radio button "yes" on "Mrn_Check Claim Page"
    When I click continue on "Mrn_Check Claim Page"
    Then I am presented with the "Mrn_Check These Bank Details Are Correct Page"
    When I click continue on "Mrn_Check These Bank Details Are Correct Page"
  ...
  Scenario: happy path (mrn ni) - duplicate mrn - not ni
    ...
    And I click continue on "Mrn_Claimant Details Check Page"
    Then I am presented with the "Mrn_Claim Northern Ireland Page"
    And I select radio button "no" on "Mrn_Claim Northern Ireland Page"
    And I click continue on "Mrn_Claim Northern Ireland Page"
