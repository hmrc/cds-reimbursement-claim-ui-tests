...
Feature: C285 - Entry Number - importer-company
  ...
  Scenario: User is a CDS Trader - happy path (entry number) - duplicate Entry Number
    ...
    When I select radio button "Duplicate Entry" on "Entry_Choose Basis For Claim Page"
  ...
  Scenario: User is a CDS Trader - happy path (entry number)
    ...
    And I click continue on "Entry_Enter Your Contact Details Page"
    Then I am presented with the "Entry_Choose Basis For Claim Page"
    When I select radio button "Incorrect Commodity Code" on "Entry_Choose Basis For Claim Page"
    And I click continue on "Entry_Choose Basis For Claim Page"
    Then I am presented with the "Entry_Enter Commodity Details Page"
    When I enter "under 500 characters" on "Entry_Enter Commodity Details Page"
    And I click continue on "Entry_Enter Commodity Details Page"
