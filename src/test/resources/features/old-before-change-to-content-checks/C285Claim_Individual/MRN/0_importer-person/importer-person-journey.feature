...
Feature: C285 - MRN - importer-person
  ...
  Scenario: User is a CDS Trader - happy path (mrn)
    ...
    And I select radio button "yes" on "Mrn_Enter Your Details As Registered With CDS"
    ...
    When I select radio button "Incorrect Value" on "Mrn_Choose Basis For Claim Page"
  ...
  Scenario: User is a CDS Trader - happy path (mrn) - change mrn
    ...
    And I click continue on "Mrn_Enter Commodity Details Page"
    Then I am presented with the "Mrn_Select Duties Page"
    When I select "A80" on "Mrn_Select Duties Page"
    And I click continue on "Mrn_Select Duties Page"
    Then I am presented with the "Mrn_Enter Claim Page" "A80 - Definitive Anti-Dumping Duty"
    When I enter "10" on "Mrn_Enter Claim Page"
    And I click continue on "Mrn_Enter Claim Page"
    ...
    When I click continue on "Mrn_Supporting Evidence Check Your Answers Page"
    Then I am presented with the "Mrn_Check Answers Accept Send Page"
    When I click "change reference number" on "Mrn_Check Answers Accept Send Page"
    Then I am presented with the "Enter Movement Reference Number Page"
...
#    And I click continue on "Mrn_Enter Claim Page"
  ...
  Scenario: User is a CDS Trader - sad path (mrn) - same duplicate mrn & legacy number attempt
    ...
    And I click continue on "Mrn_Choose Basis For Claim Page"
    Then I am presented with the "Mrn_Enter Duplicate Movement Reference Number Page"
    When I enter "10AAAAAAAAAAAAAAA1" on "Mrn_Enter Duplicate Movement Reference Number Page"
    And I click continue on "Mrn_Enter Duplicate Movement Reference Number Page"
    Then I am presented with the "Mrn_Enter Duplicate Movement Reference Number Page" error page
    When I enter "000000001A00000001" on "Mrn_Enter Duplicate Movement Reference Number Page"
    And I click continue on "Mrn_Enter Duplicate Movement Reference Number Page"
    Then I am presented with the "Mrn_Enter Duplicate Movement Reference Number Page" error page
    When I enter "20AAAAAAAAAAAAAAA1" on "Mrn_Enter Duplicate Movement Reference Number Page"
    And I click continue on "Mrn_Enter Duplicate Movement Reference Number Page"
  ...
  Scenario: User is a CDS Trader - happy path (mrn - enter importer and declarant EORIs)
    ...
    And I click continue on "Mrn_Who Is The Declarant Page"
    Then I am presented with the "Mrn_Enter Your Details As Registered With CDS"
    When I enter "" on "Mrn_Enter Your Details As Registered With CDS"
    Then I am presented with the "Mrn_Choose Basis For Claim Page"
    When I select radio button "Incorrect Value" on "Mrn_Choose Basis For Claim Page"
    And I click continue on "Mrn_Choose Basis For Claim Page"
    Then I am presented with the "Mrn_Enter Commodity Details Page"
  ...
  Scenario: User is a CDS Trader -  Claim submission failed page (change mrn)
    Given I navigate to the "Auth Login Stub Page"
    When I enter redirectURL on "Auth Login Stub Page"
    And I enter Enrollment Key "HMRC-CUS-ORG", ID Name "EORINumber" and ID Value "AB12345678901234A" on "Auth Login Stub Page"
    And I click continue on "Auth Login Stub Page"
    Then I am presented with the "Check Eori Details Page"
    When I select radio button "yes" on "Check Eori Details Page"
    And I click continue on "Check Eori Details Page"
    Then I am presented with the "Enter Movement Reference Number Page"
    When I enter "20ABCDEFGHIJKLMNO1" on "Enter Movement Reference Number Page"
    And I click continue on "Enter Movement Reference Number Page"
    Then I am presented with the "Mrn_Importer Eori Entry Page"
    When I enter "GB123456789012345" on "Mrn_Importer Eori Entry Page"
    And I click continue on "Mrn_Importer Eori Entry Page"
    ...
    Then I am presented with the "Mrn_Check Answers Accept Send Page"
    And I click continue on "Mrn_Check Answers Accept Send Page"
    Then I am presented with the "Mrn_Check If Claim Was Sent Page"
