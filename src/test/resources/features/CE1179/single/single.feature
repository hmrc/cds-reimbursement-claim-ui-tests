 ...
 # NEW CHANGE CDSR-3827
  ...
  Scenario: happy path - check importer/declarant eori pages, Special circumstances, CMA eligible
    ...
    And I should see the following details
      ...
      | Special circumstances               | Mr John Smith,someemail@mail.com,01234567890 | Commercial invoice:,document.pdf,Import or export declaration:,image.jpg | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom  | £580.00 | 10AAAAAAAAAAAAAAA2     | £161.00                                   | 10 October 2020 | £218.00                               | under 500 characters                        | Importer address:,11 Mount Road,London,E10 7PP,United Kingdom | £10.00                                | Return the goods by road, rail, air or ship |A80 - Definitive Anti-Dumping Duty,A95 - Provisional Countervailing Duty,A90 - Definitive Countervailing Duty,A85 - Provisional Anti-Dumping Duty |under 500 characters                             | Current Month Adjustment (CMA) |
    And I click continue on "CE1179_Single_Check Your Answers Page"
    Then I am presented with the "CE1179_Single_Claim Submitted Page"
