...
Feature: C&E1179 Single
  ...
  Scenario: happy path - check importer/declarant eori pages, change contact details, change bank details
    ...
    Then I am presented with the "CE1179_Single_Choose File Type Page"
    When I select radio button "Import and export declaration" on "CE1179_Single_Choose File Type Page"
    And I click continue on "CE1179_Single_Choose File Type Page"
    ...
    And I should see the following details
      | This is the basis behind the claim        | Import date      | Contact details                              | Importer email       | Uploaded                                                                | Contact address                                   | Name on the account | Importer telephone | Importer name    | Account number   | Declarant name     | Importer address                                 | Declarant address                                 | Total   | Method                | MRN                | Duties paid | Sort code      | A85 - Provisional Anti-Dumping Duty | Inspection address type | Inspection date | A90 - Definitive Countervailing Duty | These are the details of the rejected goods | A80 - Definitive Anti-Dumping Duty | Inspection address                          | A95 - Provisional Countervailing Duty | This is how the goods will be disposed of   |
      | Goods are not in accordance with contract | 12 February 2021 | Mr John Smith,someemail@mail.com,01234567890 | automation@gmail.com | document.pdf,Commercial invoice,image.jpg,Import and export declaration | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Mr John Smith       | +4420723934397     | IT Solutions LTD | Ending with 1001 | Foxpro Central LTD | 19 Bricks Road,Newcastle,NE12 5BT,United Kingdom | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | £788.00 | Bank account transfer | 10AAAAAAAAAAAAAAA2 | £828.00     | Ending with 56 | £161.00                             | Importer address        | 10 October 2020 | £218.00                              | under 500 characters                        | £208.00                            | 11 Mount Road,London,E10 7PP,United Kingdom | £201.00                               | Return the goods by road, rail, air or ship |
  ...
  @test
  Scenario: Happy path with only importer bank details and displays payee type page - choose importer - CMA not eligible
    #  60AAAAAAAAAAAAAAA5 => only importer bank details (user is only importer ) - CMA not eligible - display payee indicator page and navigates to Check Bank Details Page
    Given I navigate to the "Auth Login Stub Page"
    When I enter redirectURL on "Auth Login Stub Page"
    And I enter Enrollment Key "HMRC-CUS-ORG", ID Name "EORINumber" and ID Value "GB000000000000001" on "Auth Login Stub Page"
    And I click continue on "Auth Login Stub Page"
    ...
    And I click continue on "CE1179_Single_Enter Rejected Goods Details Page"
    Then I am presented with the "CE1179_Single_Select Duties Page"
    When I select "A80" on "CE1179_Single_Select Duties Page"
    And I click continue on "CE1179_Single_Select Duties Page"
    Then I am presented with the "CE1179_Single_Enter Claim Page" "A80 - Definitive Anti-Dumping Duty"
    When I enter "10" on "CE1179_Single_Enter Claim Page"
    And I click continue on "CE1179_Single_Enter Claim Page"
...
#    And I click continue on "CE1179_Single_Enter Claim Page"
  ...
  @test
  Scenario: Happy path with only importer bank details and displays payee type page - choose declarant - CMA not eligible
...
#    And I click continue on "CE1179_Single_Enter Claim Page"
    ...
    And I click continue on "ALF_Lookup Address Confirm Page"
    Then I am presented with the "CE1179_Single_Choose Payee Type Page"
    And I select radio button "Declarant" on "CE1179_Single_Choose Payee Type Page"
    When I click continue on "CE1179_Single_Choose Payee Type Page"
    Then I am presented with the "CE1179_Single_Bank Account Type Page"
    When I select radio button "Business bank account" on "CE1179_Single_Bank Account Type Page"
    And I click continue on "CE1179_Single_Bank Account Type Page"
  ...
  @test
  Scenario: Happy path with only importer bank details and displays payee type page - choose importer - CMA eligible
    #  60AAAAAAAAAAAAAAA5 => only importer bank details (user is only importer ) - CMA eligible - display payee indicator page and navigates to /enter-bank-account-details after /bank-account-type page
    Given I navigate to the "Auth Login Stub Page"
    When I enter redirectURL on "Auth Login Stub Page"
    And I enter Enrollment Key "HMRC-CUS-ORG", ID Name "EORINumber" and ID Value "GB000000000000001" on "Auth Login Stub Page"
    And I click continue on "Auth Login Stub Page"
...
#    And I click continue on "CE1179_Single_Enter Claim Page"
    ...
    When I select radio button "bank transfer" on "CE1179_Single_Choose Repayment Method Page"
...
#    And I click continue on "CE1179_Single_Enter Bank Account Details Page"
  ...
  Scenario: happy path - check importer/declarant eori pages, Special circumstances, CMA eligible
    ...
    Then I am presented with the "CE1179_Single_Check Your Answers Page"
    And I should see the following details
      | This is the basis behind the claim | Import date      | Contact details             | Importer email       | Uploaded                                                                | Contact address                                   | Importer telephone | Importer name    | Declarant name     | Importer address                                 | Declarant address                                 | Total  | MRN                | Duties paid | A85 - Provisional Anti-Dumping Duty | Inspection address type | Inspection date | A90 - Definitive Countervailing Duty | These are the details of the rejected goods | Inspection address                          | A95 - Provisional Countervailing Duty | This is how the goods will be disposed of   | Any special circumstances relating to your claim | Method                         |
