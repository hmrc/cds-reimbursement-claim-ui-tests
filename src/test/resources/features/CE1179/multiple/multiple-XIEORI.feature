...
#    When I click continue on "CE1179_Multiple_Check Bank Details Page"
  ...
  Scenario: happy path - don't check importer/declarant eori pages
    ...
    Then I am presented with the "CE1179_Multiple_Check Your Answers Page"
    And I should see the following details
      | This is the basis behind the claim | Import date      | Contact details                                      | Importer email       | Uploaded                        | Contact address                                  | Name on the account | Importer telephone | Importer name    | Account number   | Declarant name     | Importer address                                 | Declarant address                                 | Total  | Method of payment |20AAAAAAAAAAAAAAA1 | 10XIDAAAAAAAAAAAA1 | First MRN          | Second MRN         | Duties paid | Sort code      | Inspection address type | Inspection date | These are the details of the rejected goods | Inspection address                          | This is how the goods will be disposed of   |
