...
#    When I click continue on "CE1179_Multiple_Check Bank Details Page"
  ...
  Scenario: happy path - don't check importer/declarant eori pages
    ...
    And I should see the following details
      ...
      | Goods are defective  | John Smith,john@smith.com,01234567890  | Commercial invoice:,document.pdf | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Mr John Smith,123456,11001001  | Importer | £788.00  |£379.00    | £409.00             | 10XIDAAAAAAAAAAAA1 | 20AAAAAAAAAAAAAAA1         | 10 October 2020 | under 500 characters   | Importer address:,11 Mount Road,London,E10 7PP,United Kingdom | Return the goods by road, rail, air or ship |
    And I click continue on "CE1179_Multiple_Check Your Answers Page"
    Then I am presented with the "CE1179_Multiple_Claim Submitted Page"
