...
Feature: C&E1179 Multiple
  ...
  Scenario: happy path - with no bank details (user is both importer and declarant)
    ...
    Then I am presented with the "CE1179_Multiple_Check Your Answers Page"
    And I should see the following details
      | This is the basis behind the claim | Import date    | Contact details                                        | Importer email          | Uploaded                        | Contact address                             | Name on the account | Importer telephone | Importer name   | Account number   | Declarant name         | Importer address                            | Declarant address                                         | Total  | Method of payment |20AAAAAAAAAAAAAAA1 | 60AAAAAAAAAAAAAAA1 | First MRN          | Second MRN         | Duties paid | Sort code      | Inspection address type | Inspection date | These are the details of the rejected goods |Local Reference Number (LRN)| Inspection address                                    | This is how the goods will be disposed of   |
  ...
  Scenario: Happy path with only importer bank details and displays payee type page - choose declarant
    ...
    Then I am presented with the "CE1179_Multiple_Check Your Answers Page"
    And I should see the following details
      | This is the basis behind the claim | Import date    | Contact details                                        | Importer email          | Uploaded                     | Contact address                             | Name on the account | Importer telephone | Importer name   | Account number   | Declarant name         | Importer address                            | Declarant address                                         | Total  | Method of payment |20AAAAAAAAAAAAAAA1 | 60AAAAAAAAAAAAAAA5 | First MRN          | Second MRN         | Duties paid | Sort code      | Inspection address type | Inspection date | These are the details of the rejected goods |Local Reference Number (LRN)| Inspection address                                    | This is how the goods will be disposed of   |
