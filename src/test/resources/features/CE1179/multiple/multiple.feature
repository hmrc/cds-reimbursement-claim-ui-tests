...
Feature: C&E1179 Multiple
  ...
  Scenario: happy path - Special circumstances, CMA eligible
    ...
    Then I am presented with the "CE1179_Multiple_Check Your Answers Page"
    And I should see the following details
      | This is the basis behind the claim | Import date      | Contact details                                      | Importer email       | Uploaded                        | Contact address                                  | Name on the account | Importer telephone | Importer name    | Account number   | Declarant name     | Importer address                                 | Declarant address                                 | Total  | Method of payment |20AAAAAAAAAAAAAAA1 | 10AAAAAAAAAAAAAAA1 | First MRN          | Second MRN         | Duties paid | Sort code      | Inspection address type | Inspection date | These are the details of the rejected goods | Inspection address                          | This is how the goods will be disposed of   | Any special circumstances relating to your claim |
      | Special circumstances              | 12 February 2021 | John Smith,john@smith.com,01234567890 | automation@gmail.com | document.pdf,Commercial invoice | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | CDS E2E To E2E Bank | +4420723934397     | IT Solutions LTD | Ending with 5678 | Foxpro Central LTD | 19 Bricks Road,Newcastle,NE12 5BT,United Kingdom | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | £788.00 | Immediate Payment |£379.00             | £409.00             | 10AAAAAAAAAAAAAAA1 | 20AAAAAAAAAAAAAAA1 | £828.00     | Ending with 44 | Importer address        | 10 October 2020 | under 500 characters                        | 11 Mount Road,London,E10 7PP,United Kingdom | Return the goods by road, rail, air or ship | under 500 characters                             |
    And I click continue on "CE1179_Multiple_Check Your Answers Page"
    Then I am presented with the "CE1179_Multiple_Claim Submitted Page"
  ...
  Scenario: happy path - with no bank details (user is both importer and declarant)
    ...
    And I click continue on "ALF_Lookup Address Edit Page"
    And I click continue on "ALF_Lookup Address Confirm Page"
    Then I am presented with the "CE1179_Multiple_Bank Account Type Page"
    When I select radio button "Business bank account" on "CE1179_Multiple_Bank Account Type Page"
    And I click continue on "CE1179_Multiple_Bank Account Type Page"
    ...
    Then I am presented with the "CE1179_Multiple_Check Your Answers Page"
    And I should see the following details
      | This is the basis behind the claim | Import date    | Contact details                                        | Importer email          | Uploaded                        | Contact address                             | Name on the account | Importer telephone | Importer name   | Account number   | Declarant name         | Importer address                            | Declarant address                                         | Total  | Method of payment |20AAAAAAAAAAAAAAA1 | 60AAAAAAAAAAAAAAA1 | First MRN          | Second MRN         | Duties paid | Sort code      | Inspection address type | Inspection date | These are the details of the rejected goods | Inspection address                                    | This is how the goods will be disposed of   |
      | Goods are defective                | 13 August 2019 | John Smith,john@smith.com,01234567890 | enquiries@swftgoods.com | document.pdf,Commercial invoice | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Mr John Smith       | 0207 678 3243      | Swift Goods Ltd | Ending with 1001 | Fred Bloggs and Co Ltd | 14 Briar Lane,London,Pimlico,United Kingdom | 10 Rillington Place,London,Pimlico,W11 1RH,United Kingdom | £788.00 | Immediate Payment |£379.00             | £409.00             | 60AAAAAAAAAAAAAAA1 | 20AAAAAAAAAAAAAAA1 | £828.00     | Ending with 56 | Other address           | 10 October 2020 | under 500 characters                        | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Return the goods by road, rail, air or ship |
    And I click continue on "CE1179_Multiple_Check Your Answers Page"
    Then I am presented with the "CE1179_Multiple_Claim Submitted Page"
  ...
  Scenario: Happy path with new payee type page - user with only importer bank details and selects importer user
    ...
    Then I am presented with the "CE1179_Multiple_Check Your Answers Page"
    And I should see the following details
      | This is the basis behind the claim | Import date    | Contact details                                        | Importer email          | Uploaded                     | Contact address                             | Name on the account | Importer telephone | Importer name   | Account number   | Declarant name         | Importer address                            | Declarant address                                         | Total  | Method of payment |20AAAAAAAAAAAAAAA1 | 60AAAAAAAAAAAAAAA5 | First MRN          | Second MRN         | Duties paid | Sort code      | Inspection address type | Inspection date | These are the details of the rejected goods | Inspection address                                    | This is how the goods will be disposed of   |
      | Goods are defective                | 13 August 2019 | John Smith,john@smith.com,01234567890 | enquiries@swftgoods.com | image.jpg,Commercial invoice | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Consignee Goods Ltd | 0207 678 3243      | Swift Goods Ltd | Ending with 8523 | Fred Bloggs and Co Ltd | 14 Briar Lane,London,Pimlico,United Kingdom | 10 Rillington Place,London,Pimlico,W11 1RH,United Kingdom | £426.00 | Immediate Payment |£218.00             | £208.00             | 60AAAAAAAAAAAAAAA5 | 20AAAAAAAAAAAAAAA1 | £828.00     | Ending with 41 | Other address           | 10 October 2020 | under 500 characters                        | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Return the goods by road, rail, air or ship |
    And I click continue on "CE1179_Multiple_Check Your Answers Page"
    Then I am presented with the "CE1179_Multiple_Claim Submitted Page"
  ...
  Scenario: Happy path with only importer bank details and displays payee type page - choose declarant
    ...
    And I should see the following details
      | This is the basis behind the claim | Import date    | Contact details                                        | Importer email          | Uploaded                     | Contact address                             | Name on the account | Importer telephone | Importer name   | Account number   | Declarant name         | Importer address                            | Declarant address                                         | Total  | Method of payment |20AAAAAAAAAAAAAAA1 | 60AAAAAAAAAAAAAAA5 | First MRN          | Second MRN         | Duties paid | Sort code      | Inspection address type | Inspection date | These are the details of the rejected goods | Inspection address                                    | This is how the goods will be disposed of   |
      | Goods are defective                | 13 August 2019 | John Smith,john@smith.com,01234567890 | enquiries@swftgoods.com | image.jpg,Commercial invoice | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Mr John Smith       | 0207 678 3243      | Swift Goods Ltd | Ending with 1001 | Fred Bloggs and Co Ltd | 14 Briar Lane,London,Pimlico,United Kingdom | 10 Rillington Place,London,Pimlico,W11 1RH,United Kingdom | £426.00 | Immediate Payment |£218.00             | £208.00             | 60AAAAAAAAAAAAAAA5 | 20AAAAAAAAAAAAAAA1 | £828.00     | Ending with 56 | Other address           | 10 October 2020 | under 500 characters                        | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | Return the goods by road, rail, air or ship |
    And I click continue on "CE1179_Multiple_Check Your Answers Page"
    Then I am presented with the "CE1179_Multiple_Claim Submitted Page"


  @test
  Scenario: error message on choose disposal method
    Given I navigate to the "Auth Login Stub Page"
    When I enter redirectURL on "Auth Login Stub Page"
    And I enter Enrollment Key "HMRC-CUS-ORG", ID Name "EORINumber" and ID Value "GB000000000000001" on "Auth Login Stub Page"
    And I click continue on "Auth Login Stub Page"
    ...
    Then I am presented with the "CE1179_Multiple_Choose Disposal Method Page"
    And I click continue on "CE1179_Multiple_Choose Disposal Method Page"
    Then The error summary title is "There is a problem" and the error message is "Select the method of disposal"
