...
#    When I click continue on "CE1179_Multiple_Check Bank Details Page"
    ...
    Then I am presented with the "CE1179_Multiple_Check Your Answers Page"
    And I should see the following details
      | Basis of claim | Import date      | Contact details                                      | Importer email       | Uploaded                        | Contact address                                  | Name on the account | Importer telephone | Importer name    | Account number   | Declarant name     | Importer address                                 | Declarant address                                 | Total  | Method of payment |20AAAAAAAAAAAAAAA1 | 10AAAAAAAAAAAAAAA1 | First MRN          | Second MRN         | Duties paid | Sort code      | Inspection address type | Inspection date | Additional claim details | Inspection address                          | Disposal method   | Any special circumstances relating to your claim |
