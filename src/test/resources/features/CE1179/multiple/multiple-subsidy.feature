...
Feature: C&E1179 Multiple Subsidy
  ...
  Scenario: C&E1179 multiple MRN claim for Subsidy repayment online
    ...
    And I click continue on "CE1179_Multiple_Check Declaration Details Page"
    Then I am presented with the "CE1179_Multiple_EnterSubsidyMovementReferenceNumber2Page"
    When I enter "01AA006AAAAAAAAA01" on "CE1179_Multiple_EnterSubsidyMovementReferenceNumber2Page"
    Then I click continue on "CE1179_Multiple_EnterSubsidyMovementReferenceNumber2Page"
    ...
    Then I am presented with the "CE1179_Multiple_Subsidy_SelectDuties1Page"
    And I am presented with the "CE1179_Multiple_Subsidy_SelectDuties1Page" "These are the duties that have been paid under MRN: 00AA006AAAAAAAAA01"
    When I select "A80,A95,A90,A85" on "CE1179_Multiple_Subsidy_SelectDuties1Page"
    And I click continue on "CE1179_Multiple_Subsidy_SelectDuties1Page"
    Then I am presented with the "CE1179_Multiple_Subsidy_SelectDuties1DutyPage" "A80 - Definitive Anti-Dumping Duty"
    When I enter "20" on "CE1179_Multiple_Subsidy_SelectDuties1DutyPage"
    And I click continue on "CE1179_Multiple_Subsidy_SelectDuties1DutyPage"
    Then I am presented with the "CE1179_Multiple_Subsidy_SelectDuties1DutyPage" "A95 - Provisional Countervailing Duty"
    When I enter "10" on "CE1179_Multiple_Subsidy_SelectDuties1DutyPage"
    And I click continue on "CE1179_Multiple_Subsidy_SelectDuties1DutyPage"
    Then I am presented with the "CE1179_Multiple_Subsidy_SelectDuties1DutyPage" "A90 - Definitive Countervailing Duty"
    When I enter "20" on "CE1179_Multiple_Subsidy_SelectDuties1DutyPage"
    And I click continue on "CE1179_Multiple_Subsidy_SelectDuties1DutyPage"
    Then I am presented with the "CE1179_Multiple_Subsidy_SelectDuties1DutyPage" "A85 - Provisional Anti-Dumping Duty"
    When I enter "10" on "CE1179_Multiple_Subsidy_SelectDuties1DutyPage"
    And I click continue on "CE1179_Multiple_Subsidy_SelectDuties1DutyPage"
    Then I am presented with the "CE1179_Multiple_Subsidy_SelectDuties2Page"
    When I select "A80,A95,A90,A85" on "CE1179_Multiple_Subsidy_SelectDuties2Page"
    And I click continue on "CE1179_Multiple_Subsidy_SelectDuties2Page"
    Then I am presented with the "CE1179_Multiple_Subsidy_SelectDuties2DutyPage" "A80 - Definitive Anti-Dumping Duty"
    When I enter "20" on "CE1179_Multiple_Subsidy_SelectDuties2DutyPage"
    And I click continue on "CE1179_Multiple_Subsidy_SelectDuties2DutyPage"
    Then I am presented with the "CE1179_Multiple_Subsidy_SelectDuties2DutyPage" "A95 - Provisional Countervailing Duty"
    When I enter "30" on "CE1179_Multiple_Subsidy_SelectDuties2DutyPage"
    And I click continue on "CE1179_Multiple_Subsidy_SelectDuties2DutyPage"
    Then I am presented with the "CE1179_Multiple_Subsidy_SelectDuties2DutyPage" "A90 - Definitive Countervailing Duty"
    When I enter "50" on "CE1179_Multiple_Subsidy_SelectDuties2DutyPage"
    And I click continue on "CE1179_Multiple_Subsidy_SelectDuties2DutyPage"
    Then I am presented with the "CE1179_Multiple_Subsidy_SelectDuties2DutyPage" "A85 - Provisional Anti-Dumping Duty"
    When I enter "40" on "CE1179_Multiple_Subsidy_SelectDuties2DutyPage"
    And I click continue on "CE1179_Multiple_Subsidy_SelectDuties2DutyPage"
    ...
    And I should see the following details
      ...
      | Goods are not in accordance with contract | 01AA006AAAAAAAAA01 | 12 February 2021 | Online Sales LTD,automation@gmail.com,+4420723934397 | automation@gmail.com | image.jpg,Commercial invoice | 19 Bricks Road,Newcastle,NE12 5BT,United Kingdom | +4420723934397     | IT Solutions LTD | Foxpro Central LTD | Subsidy           | 19 Bricks Road,Newcastle,NE12 5BT,United Kingdom | 12 Skybricks Road,Coventry,CV3 6EA,United Kingdom | £1,456.00 | Subsidy allocation | 00AA006AAAAAAAAA01 | £828.00     | £768.00             | Importer address        | 10 October 2020 | £688.00            | under 500 characters                        | 11 Mount Road,London,E10 7PP,United Kingdom | Return the goods by road, rail, air or ship |
