...
object C285_Multiple_CheckMovementReferenceNumbersPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/multiple/check-movement-reference-numbers"
