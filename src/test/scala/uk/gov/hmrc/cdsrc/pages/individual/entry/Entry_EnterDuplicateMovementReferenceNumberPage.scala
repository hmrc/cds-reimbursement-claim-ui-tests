...
object Entry_EnterDuplicateMovementReferenceNumberPage extends BasePage {
  ...
  override def checkContent(content: String): Unit = {
    ...
    driver.findElement(By.cssSelector("#main-content > div > div > form > div > label")).getText should equal("What is your duplicated Movement Reference Number (MRN)?")
    driver.findElement(By.cssSelector("#enter-duplicate-movement-reference-number-hint")).getText should equal("Must be 18 or 17 characters, for example 19GB03I52858027017.")
