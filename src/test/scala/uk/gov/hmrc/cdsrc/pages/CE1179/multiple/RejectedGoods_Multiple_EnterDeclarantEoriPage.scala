...
object RejectedGoods_Multiple_EnterDeclarantEoriPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/multiple/enter-declarant-eori"
