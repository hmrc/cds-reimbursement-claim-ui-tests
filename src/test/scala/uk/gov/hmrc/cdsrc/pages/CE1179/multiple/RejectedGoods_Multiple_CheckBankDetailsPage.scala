...
object RejectedGoods_Multiple_CheckBankDetailsPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/multiple/check-bank-details"
