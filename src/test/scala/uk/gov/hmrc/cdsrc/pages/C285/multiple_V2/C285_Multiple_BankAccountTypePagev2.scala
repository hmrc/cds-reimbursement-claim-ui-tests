...
object C285_Multiple_BankAccountTypePagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/multiple/choose-bank-account-type"
