...
object C285_Scheduled_ClaimSubmittedPagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/v2/scheduled/claim-submitted"
