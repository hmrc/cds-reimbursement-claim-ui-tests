...
object CE1179_Multiple_ChooseDisposalMethodPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/multiple/choose-disposal-method"
  override val title       = "Choose what you intend to do with the goods"

  override def expectedPageErrorTitle: Option[String] = Some(
    "How will you dispose of the goods? - Claim back import duty and VAT - GOV.UK"
  )
