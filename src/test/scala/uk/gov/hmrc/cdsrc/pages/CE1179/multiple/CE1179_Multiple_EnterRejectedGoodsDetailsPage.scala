...
object CE1179_Multiple_EnterRejectedGoodsDetailsPage extends BasePage {

  override val url: String =
    TestConfiguration.url("cds-frontend") + "/rejected-goods/multiple/enter-rejected-goods-details"
