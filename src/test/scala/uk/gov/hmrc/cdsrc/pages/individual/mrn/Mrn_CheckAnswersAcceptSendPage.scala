  ...
  override def checkContent(content: String): Unit = {
    content match {
      ...
      case "check content" =>
        ...
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(13) > div > dt")).getText should equal("Details of the commodities")
        ...
        driver.findElement(By.cssSelector("#main-content > div > div > h2:nth-child(18)")).getText should equal("Supporting documents")
      ...
      case "3 files" =>
        ...
        driver.findElement(By.cssSelector("#main-content > div > div > h2:nth-child(10)")).getText should equal("Basis for claim")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div > dt")).getText should equal("This is the basis behind the claim")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div > dd.govuk-summary-list__value")).getText should equal("Duty Suspension")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div > dd.govuk-summary-list__actions > a")).getText should equal("Change\nThis is the basis behind the claim")
        ...
        driver.findElement(By.cssSelector("#main-content > div > div > h2:nth-child(18)")).getText should equal("Supporting documents")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(19) > div > dt")).getText should equal("Uploaded")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(19) > div > dd.govuk-summary-list__value > p:nth-child(1)")).getText should equal("document.pdf\nPacking List")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(19) > div > dd.govuk-summary-list__value > p:nth-child(2)")).getText should equal("document.pdf\nImport and Export Declaration")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(19) > div > dd.govuk-summary-list__value > p:nth-child(3)")).getText should equal("document.pdf\nCommercial Invoice")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(19) > div > dd.govuk-summary-list__actions > a")).getText should equal("Change\nUploaded")
