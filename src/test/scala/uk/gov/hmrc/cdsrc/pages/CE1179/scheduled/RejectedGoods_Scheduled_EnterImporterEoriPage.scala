...
object RejectedGoods_Scheduled_EnterImporterEoriPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/scheduled/enter-importer-eori"
