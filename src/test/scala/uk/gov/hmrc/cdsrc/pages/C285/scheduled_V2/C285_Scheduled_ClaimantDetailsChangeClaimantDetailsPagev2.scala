...
object C285_Scheduled_ClaimantDetailsChangeClaimantDetailsPagev2 extends BasePage {
  ...
  override val url: String =
    TestConfiguration.url("cds-frontend") + "/overpayments/scheduled/claimant-details/change-contact-details"
  override val title       = "Who should we contact about this claim?"

  override def expectedPageErrorTitle: Option[String] = Some(
    "ERROR: Who should we contact about this claim? - Claim back import duty and VAT - GOV.UK"
  )
