  ...
  override def checkContent(content: String): Unit = {
    content match {
      case "check content" =>
        ...
        driver.findElement(By.cssSelector("#main-content > div > div > h2:nth-child(10)")).getText should equal("Claimant’s contact details")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div:nth-child(1) > dt")).getText should equal("Full name")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div:nth-child(2) > dt")).getText should equal("Email address")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div:nth-child(3) > dt")).getText should equal("Phone number")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div:nth-child(4) > dt")).getText should equal("Contact address")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div:nth-child(1) > dd.govuk-summary-list__value")).getText should equal("Online Sales LTD")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div:nth-child(2) > dd.govuk-summary-list__value")).getText should equal("someemail@mail.com")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div:nth-child(3) > dd.govuk-summary-list__value")).getText should equal("+4420723934397")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div:nth-child(4) > dd.govuk-summary-list__value")).getText should equal("11 Mount Road, London, E10 7PP, United Kingdom")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div:nth-child(1) > dd.govuk-summary-list__actions > a")).getText should equal("Change\nFull name")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div:nth-child(2) > dd.govuk-summary-list__actions > a")).getText should equal("Change\nEmail address")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div:nth-child(3) > dd.govuk-summary-list__actions > a")).getText should equal("Change\nPhone number")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(11) > div:nth-child(4) > dd.govuk-summary-list__actions > a")).getText should equal("Change\nContact address")

        driver.findElement(By.cssSelector("#main-content > div > div > h2:nth-child(12)")).getText should equal("Reason or basis for claim")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(13) > div > dt")).getText should equal("Reason")
        driver.findElement(By.cssSelector("#main-content > div > div > dl:nth-child(13) > div > dd.govuk-summary-list__value")).getText should equal("OPR")
