...
object C285_Single_ChoosePayeeTypev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/v2/single/choose-payee-type"
