...
object C285_Scheduled_SelectDutiesDutyTypeDutyPagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/v2/scheduled/enter-claim/..."
  override val title = ""
