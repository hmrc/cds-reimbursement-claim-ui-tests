...
object Multiple_CheckDeclarationDetailsPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/multiple/check-declaration-details"
  ...
  override def checkContent(content: String): Unit = {
    ...
    content match {
      case "10AAAAAAAAAAAAAAA6" =>
        driver.findElement(By.cssSelector("#main-content > div > div > form > dl > div:nth-child(2) > dt")).getText should equal("Lead MRN")
        ...
        driver.findElement(By.cssSelector("#main-content > div > div > form > dl > div:nth-child(6) > dt")).getText should equal("Importer address")
        driver.findElement(By.cssSelector("#main-content > div > div > form > dl > div:nth-child(7) > dt")).getText should equal("Declarant name")
        driver.findElement(By.cssSelector("#main-content > div > div > form > dl > div:nth-child(8) > dt")).getText should equal("Declarant address")
        ...
        driver.findElement(By.cssSelector("#main-content > div > div > form > dl > div:nth-child(6) > dd")).getText should equal("19 Bricks Road\nNewcastle\nNE12 5BT\nGB")
        driver.findElement(By.cssSelector("#main-content > div > div > form > dl > div:nth-child(7) > dd")).getText should equal("Foxpro Central LTD")
        driver.findElement(By.cssSelector("#main-content > div > div > form > dl > div:nth-child(8) > dd")).getText should equal("12 Skybricks Road\nCoventry\nCV3 6EA\nGB")
      case "50AAAAAAAAAAAAAAA1" =>
        ...
        driver.findElement(By.cssSelector("#main-content > div > div > form > dl > div:nth-child(3) > dd")).getText should equal("12 February 2021")
        driver.findElement(By.cssSelector("#main-content > div > div > form > dl > div:nth-child(4) > dd")).getText should equal("£1,341.00")
        driver.findElement(By.cssSelector("#main-content > div > div > form > dl > div:nth-child(5) > dd")).getText should equal("IT Solutions LTD")
