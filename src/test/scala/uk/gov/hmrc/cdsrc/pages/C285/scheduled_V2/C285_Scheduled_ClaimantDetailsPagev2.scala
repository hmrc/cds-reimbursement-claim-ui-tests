...
object C285_Scheduled_ClaimantDetailsPagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/v2/scheduled/claimant-details"
