...
object RejectedGoods_Multiple_InspectionAddressChooseTypePage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/multiple/inspection-address/choose-type"
