...
object C285_Multiple_ChoosePayeeTypev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/v2/multiple/choose-payee-type"
