...
object RejectedGoods_Multiple_ClaimSubmittedPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/multiple/claim-submitted"
