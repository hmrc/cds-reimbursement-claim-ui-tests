...
object C285_Scheduled_CheckAnswersAcceptSendPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/scheduled/check-answers-accept-send"
