...
object C285_Single_BankAccountTypePagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/single/choose-bank-account-type"
