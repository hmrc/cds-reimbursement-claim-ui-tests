...
object C285_Scheduled_BankAccountTypePagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/scheduled/choose-bank-account-type"
