...
object CE1179_Scheduled_EnterRejectedGoodsDetailsPage extends BasePage {

  override val url: String =
    TestConfiguration.url("cds-frontend") + "/rejected-goods/scheduled/enter-rejected-goods-details"
  ...
  override def enterDetails(details: String): Unit =
    details match {
      ...
      case "over 500 characters"  =>
        enterText(
          "enter-rejected-goods-details.rejected-goods",
