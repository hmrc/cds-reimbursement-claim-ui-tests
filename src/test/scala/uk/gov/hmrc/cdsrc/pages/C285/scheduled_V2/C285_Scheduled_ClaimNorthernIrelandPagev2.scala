...
object C285_Scheduled_ClaimNorthernIrelandPagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/v2/scheduled/claim-northern-ireland"
