...
object Securities_SelectSecuritiesSecurityIdPage extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some(
    "Error: Include this security deposit in your claim? - Claim back import duty and VAT - GOV.UK"
  )

  override def expectedPageTitle: Option[String] = Some(
    "Include this security deposit in your claim? - Claim back import duty and VAT - GOV.UK"
  )
