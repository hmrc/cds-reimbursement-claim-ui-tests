...
object RejectedGoods_Scheduled_CheckDeclarationDetailsPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/scheduled/check-declaration-details"
  ...
  override def clickRadioButton(text: String): Unit = {
    text.toLowerCase() match {
      case "yes" => click on id("check-declaration-details.scheduled")
      case "no" => click on id("check-declaration-details.scheduled-2")
    }
  }
