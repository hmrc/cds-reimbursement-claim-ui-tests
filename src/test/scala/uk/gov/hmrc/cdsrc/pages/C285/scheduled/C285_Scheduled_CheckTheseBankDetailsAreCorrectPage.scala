...
object C285_Scheduled_CheckTheseBankDetailsAreCorrectPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/scheduled/check-these-bank-details-are-correct"
