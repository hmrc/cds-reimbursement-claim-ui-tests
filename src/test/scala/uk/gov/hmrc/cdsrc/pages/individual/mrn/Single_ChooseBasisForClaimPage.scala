...
object Single_ChooseBasisForClaimPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/single/choose-basis-for-claim"
  ...
  override def checkContent(content: String): Unit = {
    ...
    driver.findElement(By.cssSelector("#main-content > div > div > details > div > ul > li:nth-child(2)")).getText should equal("Incorrect EORI and deferment account number: A claim made if a trader entered a wrong EORI and/or deferment account number")
    driver.findElement(By.cssSelector("#main-content > div > div > details > div > ul > li:nth-child(3)")).getText should equal("Duty suspension: Goods liable to import charges but not collected until they leave the point of deferring payment of customs duties")
    driver.findElement(By.cssSelector("#main-content > div > div > details > div > ul > li:nth-child(4)")).getText should equal("End use relief: Gives a favourable rate of duty and/or levy on some goods imported from non-EU countries")
    driver.findElement(By.cssSelector("#main-content > div > div > details > div > ul > li:nth-child(5)")).getText should equal("Incorrect commodity code: A claim made if a trader originally entered an incorrect commodity code and overpaid duties")
    driver.findElement(By.cssSelector("#main-content > div > div > details > div > ul > li:nth-child(6)")).getText should equal("Incorrect customs procedure code: A claim made if a trader entered an incorrect CPC and overpaid duties")
    driver.findElement(By.cssSelector("#main-content > div > div > details > div > ul > li:nth-child(7)")).getText should equal("Incorrect value: A claim made if a trader originally entered an incorrect total customs value and overpaid duties")
    ...
    driver.findElement(By.cssSelector("#main-content > div > div > details > div > ul > li:nth-child(12)")).getText should equal("Incorrect excise value - Northern Ireland claims only: Claims for post-clearance cash repayment of excise differential because the trader made a genuine error when manually calculating excise. Note: under this basis for claim, if you imported into Northern Ireland, you can only claim under excise tax codes and not under customs tax codes or import VAT.")
    driver.findElement(By.cssSelector("#main-content > div > div > details > div > ul > li:nth-child(13)")).getText should equal("Incorrect Additional Information code (excluding NIAID) - Northern Ireland claims only: The trader has declared goods as at risk in error, pays the tariff themselves (i.e. does not use subsidy) and wants to correct this error post-clearance")
    ...
    content match {
      case "ni" =>
        ...
        driver.findElement(By.cssSelector("#main-content > div > div > form > div > fieldset > div > div:nth-child(2) > label")).getText should equal("Incorrect EORI & Deferment Acc. Num.")
        driver.findElement(By.cssSelector("#main-content > div > div > form > div > fieldset > div > div:nth-child(3) > label")).getText should equal("Duty Suspension")
        driver.findElement(By.cssSelector("#main-content > div > div > form > div > fieldset > div > div:nth-child(4) > label")).getText should equal("End Use")
        driver.findElement(By.cssSelector("#main-content > div > div > form > div > fieldset > div > div:nth-child(5) > label")).getText should equal("Incorrect Commodity Code")
        driver.findElement(By.cssSelector("#main-content > div > div > form > div > fieldset > div > div:nth-child(6) > label")).getText should equal("Incorrect CPC")
        driver.findElement(By.cssSelector("#main-content > div > div > form > div > fieldset > div > div:nth-child(7) > label")).getText should equal("Incorrect Value")
