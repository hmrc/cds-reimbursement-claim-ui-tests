...
object C285_Multiple_CheckAnswersAcceptSendPagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/multiple/check-your-answers"
