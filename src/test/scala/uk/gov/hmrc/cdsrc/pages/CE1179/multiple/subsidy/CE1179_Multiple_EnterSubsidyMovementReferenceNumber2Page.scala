...
object CE1179_Multiple_EnterSubsidyMovementReferenceNumber2Page extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some(
    "Error: Enter the second subsidy Movement Reference Number (MRN) - Claim back import duty and VAT - GOV.UK"
  )

  override def expectedPageTitle: Option[String] = Some(
    "Enter the second subsidy Movement Reference Number (MRN) - Claim back import duty and VAT - GOV.UK"
  )
