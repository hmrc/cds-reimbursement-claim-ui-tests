...
object C285_Single_NewTaxTypeCodeValidationPagev2 extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some(
    "Sorry, there is a problem with this Movement Reference Number (MRN) - Claim back import duty and VAT - GOV.UK"
  )
  ...
  override def expectedPageHeader: Option[String] = Some(
    "Sorry, there is a problem with this Movement Reference Number (MRN)"
  )
