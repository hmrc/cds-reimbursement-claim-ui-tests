...
object C285_Scheduled_EnterAdditionalDetailsPagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/v2/scheduled/enter-additional-details"
