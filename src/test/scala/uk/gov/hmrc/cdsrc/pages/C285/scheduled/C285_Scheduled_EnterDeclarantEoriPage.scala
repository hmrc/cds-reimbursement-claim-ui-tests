...
object C285_Scheduled_EnterDeclarantEoriPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/scheduled/enter-declarant-eori"
