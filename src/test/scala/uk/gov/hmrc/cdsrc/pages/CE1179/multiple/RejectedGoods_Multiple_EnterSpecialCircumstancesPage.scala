...
object RejectedGoods_Multiple_EnterSpecialCircumstancesPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/multiple/enter-special-circumstances"
