...
object C285_Single_SupportingEvidenceCheckYourAnswers2Page extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some(
    "You have added 2 documents to your claim - Claim back import duty and VAT - GOV.UK"
  )
