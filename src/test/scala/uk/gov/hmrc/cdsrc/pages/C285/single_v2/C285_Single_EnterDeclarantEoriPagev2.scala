...
object C285_Single_EnterDeclarantEoriPagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/v2/single/enter-declarant-eori"
