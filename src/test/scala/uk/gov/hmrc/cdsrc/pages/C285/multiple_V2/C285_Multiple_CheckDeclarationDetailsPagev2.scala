...
object C285_Multiple_CheckDeclarationDetailsPagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/v2/multiple/check-declaration-details"
