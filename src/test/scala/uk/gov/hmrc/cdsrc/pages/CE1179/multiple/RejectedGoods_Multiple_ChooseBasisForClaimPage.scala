...
object RejectedGoods_Multiple_ChooseBasisForClaimPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/multiple/choose-basis-for-claim"
