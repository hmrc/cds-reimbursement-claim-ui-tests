...
object RejectedGoods_Multiple_CheckClaimPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/multiple/check-claim"
  ...
  override def clickRadioButton(text: String): Unit = {
    text.toLowerCase() match {
      case "yes" => click on xpath(s"""//*[@id="check-claim.rejected-goods"]""")
      case "no" => click on xpath(s"""//*[@id="check-claim.rejected-goods-2"]""")
    }
  }
