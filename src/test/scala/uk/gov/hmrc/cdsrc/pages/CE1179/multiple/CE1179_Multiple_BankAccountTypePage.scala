...
object CE1179_Multiple_BankAccountTypePage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/multiple/choose-bank-account-type"
