...
object C285_Single_EnterBankAccountDetailsPagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/v2/single/enter-bank-account-details"
