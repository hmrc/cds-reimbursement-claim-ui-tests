...
object Securities_SelectSecuritiesSecurityIdPage1 extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some(
    "Error: Security 1 of 5: Include this security deposit in your claim? - Claim back import duty and VAT - GOV.UK"
  )

  override def expectedPageTitle: Option[String] = Some(
    "Security 1 of 5: Include this security deposit in your claim? - Claim back import duty and VAT - GOV.UK"
  )

  override def expectedPageHeader: Option[String] = Some("""Security 1 of 5
