...
object Single_NotSubscribedForCDSPage extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some("Not registered with CDS - Claim back import duty and VAT - GOV.UK")

  override def expectedPageTitle: Option[String] = Some("Not registered with CDS - Claim back import duty and VAT - GOV.UK")
