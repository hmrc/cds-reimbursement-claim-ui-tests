...
object CE1179_Single_InspectionAddressChooseTypePage extends BasePage {

  override val url: String =
    TestConfiguration.url("cds-frontend") + "/rejected-goods/single/inspection-address/choose-type"
