...
object CE1179_Multiple_ChoosePayeeTypePage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/multiple/choose-payee-type"
