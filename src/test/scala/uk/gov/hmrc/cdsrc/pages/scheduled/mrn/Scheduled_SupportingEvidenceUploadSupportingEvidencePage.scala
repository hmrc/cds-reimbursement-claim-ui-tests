...
object Scheduled_SupportingEvidenceUploadSupportingEvidencePage extends BasePage {
  ...
  override def checkContent(content: String): Unit = {
    driver.findElement(By.cssSelector("#main-content > div > div > p")).getText should equal("Upload supporting evidence of the commodities imported for all of your MRNs. The documents can be up to a maximum of 10MB size per file. Valid file format: JPG, PNG, PDF.")
