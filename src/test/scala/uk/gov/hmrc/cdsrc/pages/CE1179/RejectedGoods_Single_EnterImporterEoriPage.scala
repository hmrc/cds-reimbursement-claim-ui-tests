...
object RejectedGoods_Single_EnterImporterEoriPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/single/enter-importer-eori"
