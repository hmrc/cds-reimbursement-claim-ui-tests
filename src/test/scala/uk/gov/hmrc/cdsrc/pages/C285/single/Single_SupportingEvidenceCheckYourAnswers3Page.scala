...
object Single_SupportingEvidenceCheckYourAnswers3Page extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some("You have added 3 documents to your claim - Claim back import duty and VAT - GOV.UK")

  override def expectedPageTitle: Option[String] = Some("You have added 3 documents to your claim - Claim back import duty and VAT - GOV.UK")
