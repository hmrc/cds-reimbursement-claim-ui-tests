...
object CheckEoriDetailsPage extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some("Check these EORI details are correct - Claim for reimbursement of import duties - GOV.UK")

  override def expectedPageTitle: Option[String] = Some("Check these EORI details are correct - Claim for reimbursement of import duties - GOV.UK")
