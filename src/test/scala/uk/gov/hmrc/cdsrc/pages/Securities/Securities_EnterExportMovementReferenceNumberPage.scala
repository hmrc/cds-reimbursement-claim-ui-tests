...
object Securities_EnterExportMovementReferenceNumberPage extends BasePage {
  ...
  override def expectedPageTitle: Option[String] = Some(
    "Enter the export MRN in the declaration - Claim back import duty and VAT - GOV.UK"
  )
