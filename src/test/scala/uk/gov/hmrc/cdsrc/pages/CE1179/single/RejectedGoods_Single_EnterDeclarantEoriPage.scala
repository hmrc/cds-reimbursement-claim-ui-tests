...
object RejectedGoods_Single_EnterDeclarantEoriPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/single/enter-declarant-eori"
