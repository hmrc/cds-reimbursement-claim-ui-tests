...
object C285_Single_ClaimSubmittedPagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/v2/single/claim-submitted"
