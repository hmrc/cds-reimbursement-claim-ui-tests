...
object RejectedGoods_Scheduled_EnterRejectedGoodsDetailsPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/scheduled/enter-rejected-goods-details"
