...
object C285_Multiple_SelectDuties4DutyPagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/multiple/enter-claim/4/..."
  override val title       = ""
