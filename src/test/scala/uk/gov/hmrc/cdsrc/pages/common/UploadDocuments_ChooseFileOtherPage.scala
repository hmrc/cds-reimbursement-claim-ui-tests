...
object UploadDocuments_ChooseFileOtherPage extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some("Add documents to support your claim - Claim back import duty and VAT - GOV.UK")
