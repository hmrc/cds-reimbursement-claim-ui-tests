...
object C285_Multiple_SelectDuties3DutyPagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/multiple/enter-claim/3/..."
  override val title       = ""
