...
import uk.gov.hmrc.cdsrc.pages.C285.multiple_V2.C285_Multiple_CheckTheseBankDetailsAreCorrectPagev2.driver

import java.time.Duration

object CE1179_Scheduled_CheckBankDetailsPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/rejected-goods/scheduled/check-bank-details"
