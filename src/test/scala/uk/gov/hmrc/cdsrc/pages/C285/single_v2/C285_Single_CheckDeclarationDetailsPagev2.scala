...
object C285_Single_CheckDeclarationDetailsPagev2 extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/v2/single/check-declaration-details"
