...
object Multiple_CheckTheseBankDetailsAreCorrectPage extends BasePage {

  override val url: String = TestConfiguration.url("cds-frontend") + "/multiple/check-these-bank-details-are-correct"
