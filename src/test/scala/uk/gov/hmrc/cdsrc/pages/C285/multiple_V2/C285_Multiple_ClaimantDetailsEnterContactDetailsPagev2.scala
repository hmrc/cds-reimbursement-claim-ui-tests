...
object C285_Multiple_ClaimantDetailsEnterContactDetailsPagev2 extends BasePage {
  ...
  override val url: String = TestConfiguration.url("cds-frontend") + "/overpayments/multiple/claimant-details/change-contact-details"
  override val title = "Provide the contact details for this claim"

  override def expectedPageErrorTitle: Option[String] = Some("Provide the contact details for this claim - Claim back import duty and VAT - GOV.UK")
