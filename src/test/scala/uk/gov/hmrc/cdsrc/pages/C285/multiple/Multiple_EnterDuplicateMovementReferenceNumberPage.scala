...
object Multiple_EnterDuplicateMovementReferenceNumberPage extends BasePage {
  ...
  override def expectedPageErrorTitle: Option[String] = Some("Tell us your duplicate Movement Reference Number (MRN) - Claim back import duty and VAT - GOV.UK")

  override def expectedPageTitle: Option[String] = Some("Tell us your duplicate Movement Reference Number (MRN) - Claim back import duty and VAT - GOV.UK")
