...
class CE1179SingleXiEoriSpec extends BaseSpec {
  ...
  Feature("C&E1179 Single - XIEORI") {
    ...
    Scenario("happy path - check importer/declarant eori pages, change contact details, change bank details") {
      ...
      When("User enters 10XICDAAAAAAAAAAA1 on CE1179 Single Enter Movement Reference Number Page")
      CE1179_Single_EnterMovementReferenceNumberPage.waitForPageHeader
      CE1179_Single_EnterMovementReferenceNumberPage.enterDetails("10XICDAAAAAAAAAAA1")
      ...
      When("User enters XI000000000000001 on CE1179 Single Enter Importer Eori Page")
      CE1179_Single_EnterImporterEoriPage.waitForPageHeader
      CE1179_Single_EnterImporterEoriPage.enterDetails("XI000000000000001")
      ...
      When("User enters XI000000000000001 on CE1179 Single Enter Declarant Eori Page")
      CE1179_Single_EnterDeclarantEoriPage.waitForPageHeader
      CE1179_Single_EnterDeclarantEoriPage.enterDetails("XI000000000000001")
      ...
      val expectedData = Map(
        ...
        "Movement Reference Number (MRN)"         -> "10XICDAAAAAAAAAAA1",
