...
class ScheduledV2XiEoriSpec extends BaseSpec {
  ...
  Feature("C285 Scheduled - XIEORI V2") {
    ...
    Scenario("happy path - check importer/declarant eori pages") {
      ...
      When("User selects radio button schedule on C285 Choose How Many Mrns Page v2")
      C285_ChooseHowManyMrnsPagev2.waitForPageHeader
      ...
      Then("User is presented with the C285 Scheduled Have Your Supporting Document Ready Page v2")
      ...
      When("User clicks continue on C285 Scheduled Have Your Supporting Document Ready Page v2")
      C285_Scheduled_HaveYourSupportingDocumentReadyPagev2.waitForPageHeader
      ...
      When("User enters 10XICDAAAAAAAAAAA1 on C285 Scheduled Enter Movement Reference Number Page v2")
      C285_Scheduled_EnterMovementReferenceNumberPagev2.waitForPageHeader
      C285_Scheduled_EnterMovementReferenceNumberPagev2.enterDetails("10XICDAAAAAAAAAAA1")
      ...
      When("User enters XI000000000000001 on C285 Scheduled Enter Importer Eori Page v2")
      C285_Scheduled_EnterImporterEoriPagev2.waitForPageHeader
      C285_Scheduled_EnterImporterEoriPagev2.enterDetails("XI000000000000001")
      ...
      When("User enters XI000000000000001 on C285 Scheduled Enter Declarant Eori Page v2")
      C285_Scheduled_EnterDeclarantEoriPagev2.waitForPageHeader
      C285_Scheduled_EnterDeclarantEoriPagev2.enterDetails("XI000000000000001")
      ...
      Then("User is presented with the C285 Scheduled Check Answers Accept Send Page v2")
      ...
      val expectedData = Map(
        ...
        "Excise duty"                    -> "£115.00",
        "Total"                          -> "£135.00",
        "First Movement Reference Number (MRN)" -> "10XICDAAAAAAAAAAA1",
      ...
      When("User clicks continue on C285 Scheduled Check Answers Accept Send Page v2")
      C285_Scheduled_CheckAnswersAcceptSendPagev2.waitForPageHeader
      C285_Scheduled_CheckAnswersAcceptSendPagev2.clickContinueButton()

      Then("User is presented with the C285 Scheduled Claim Submitted Page v2")
