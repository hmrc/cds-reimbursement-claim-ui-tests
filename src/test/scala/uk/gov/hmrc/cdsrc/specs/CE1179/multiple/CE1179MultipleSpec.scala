...
class CE1179MultipleSpec extends BaseSpec {
  ...
  Feature("C&E1179 Multiple") {
    ...
    Scenario("happy path - check importer/declarant eori pages") {
      ...
      When("User enters 10AAAAAAAAAAAAAAA2 on CE1179 Multiple Enter Movement Reference Number Page")
      CE1179_Multiple_EnterMovementReferenceNumberPage.waitForPageHeader
      CE1179_Multiple_EnterMovementReferenceNumberPage.enterDetails("10AAAAAAAAAAAAAAA2")
      ...
      When("User enters GB000000000000002 on CE1179 Multiple Enter Importer Eori Page")
      CE1179_Multiple_EnterImporterEoriPage.waitForPageHeader
      CE1179_Multiple_EnterImporterEoriPage.enterDetails("GB000000000000002")
      ...
      When("User enters GB000000000000002 on CE1179 Multiple Enter Declarant Eori Page")
      CE1179_Multiple_EnterDeclarantEoriPage.waitForPageHeader
      CE1179_Multiple_EnterDeclarantEoriPage.enterDetails("GB000000000000002")
      ...
      When("User enters 20AAAAAAAAAAAAAAA2 on CE1179 Multiple Enter Movement Reference Number 2 Page")
      CE1179_Multiple_EnterMovementReferenceNumber2Page.waitForPageHeader
      CE1179_Multiple_EnterMovementReferenceNumber2Page.enterDetails("20AAAAAAAAAAAAAAA2")
    ...
    Scenario("happy path - Special circumstances, CMA eligible") {
      ...
      And("User selects radio button Up to 20 MRNs on CE1179 Choose How Many Mrns Page")
      CE1179_ChooseHowManyMrnsPage.waitForPageHeader
      CE1179_ChooseHowManyMrnsPage.clickRadioButton("Up to 20 MRNs")
      ...
      When("User enters 10AAAAAAAAAAAAAAA1 on CE1179 Multiple Enter Movement Reference Number Page")
      CE1179_Multiple_EnterMovementReferenceNumberPage.waitForPageHeader
      CE1179_Multiple_EnterMovementReferenceNumberPage.enterDetails("10AAAAAAAAAAAAAAA1")
      ...
      When("User enters 20AAAAAAAAAAAAAAA1 on CE1179 Multiple Enter Movement Reference Number 2 Page")
      CE1179_Multiple_EnterMovementReferenceNumber2Page.waitForPageHeader
      CE1179_Multiple_EnterMovementReferenceNumber2Page.enterDetails("20AAAAAAAAAAAAAAA1")
      ...
      When("User selects radio button Special circumstances on CE1179 Multiple Choose Basis For Claim Page")
      CE1179_Multiple_ChooseBasisForClaimPage.waitForPageHeader
      CE1179_Multiple_ChooseBasisForClaimPage.clickRadioButton("Special circumstances")

      And("User clicks continue on CE1179 Multiple Choose Basis For Claim Page")
      CE1179_Multiple_ChooseBasisForClaimPage.waitForPageHeader
      CE1179_Multiple_ChooseBasisForClaimPage.clickContinueButton()

      Then("User is presented with the CE1179 Multiple Enter Special Circumstances Page")
      CE1179_Multiple_EnterSpecialCircumstancesPage.waitForPageHeader
      CE1179_Multiple_EnterSpecialCircumstancesPage.checkURL
      CE1179_Multiple_EnterSpecialCircumstancesPage.checkPageHeader()
      CE1179_Multiple_EnterSpecialCircumstancesPage.checkPageTitle()
      ...
      val expectedData = Map(
        ...
        "1st MRN10AAAAAAAAAAAAAAA1"               -> "£20.00",
        "1st Movement Reference Number (MRN)"     -> "10AAAAAAAAAAAAAAA1",
    ...
    Scenario("happy path - with no bank details (user is both importer and declarant)") {
      ...
      When("User enters 60AAAAAAAAAAAAAAA1 on CE1179 Multiple Enter Movement Reference Number Page")
      CE1179_Multiple_EnterMovementReferenceNumberPage.waitForPageHeader
      CE1179_Multiple_EnterMovementReferenceNumberPage.enterDetails("60AAAAAAAAAAAAAAA1")
      ...
      When("User enters 10,10,2025 on CE1179 Multiple Enter Inspection Date Page")
      CE1179_Multiple_EnterInspectionDatePage.waitForPageHeader
      CE1179_Multiple_EnterInspectionDatePage.enterDetails("10,10,2025")
      ...
      val expectedData = Map(
        ...
        "2nd MRN"                                 -> "20AAAAAAAAAAAAAAA1",
        "Inspection date"                         -> "10 October 2025",
        "Additional claim information"            -> "under 500 characters",
        "Inspection address"                      -> "Other address",
        "Disposal method"                         -> "Return the goods by road, rail, air or ship"
      )
      expectedData.foreach { case (k, v) => info(s"- $k: $v") }
      CE1179_Multiple_CheckYourAnswersPage.pageData should be(expectedData)
    ...
    Scenario("error scenario - second mrn not linked to importer/declarant eori") {
      ...
      When("User enters 10AAAAAAAAAAAAAAA1 on CE1179 Multiple Enter Movement Reference Number 2 Page")
      CE1179_Multiple_EnterMovementReferenceNumber2Page.waitForPageHeader
      CE1179_Multiple_EnterMovementReferenceNumber2Page.enterDetails("10AAAAAAAAAAAAAAA1")

      And("User clicks continue on CE1179 Multiple Enter Movement Reference Number 2 Page")
      CE1179_Multiple_EnterMovementReferenceNumber2Page.waitForPageHeader
      CE1179_Multiple_EnterMovementReferenceNumber2Page.clickContinueButton()

      Then("User is presented with the CE1179 Multiple Enter Movement Reference Number 2 Page error page")
      CE1179_Multiple_EnterMovementReferenceNumber2Page.waitForPageHeader
      CE1179_Multiple_EnterMovementReferenceNumber2Page.checkURL
      CE1179_Multiple_EnterMovementReferenceNumber2Page.checkPageErrorTitle()
    }
    ...
    Scenario("Happy path with only importer bank details and displays payee type page - choose declarant") {
      ...
      When("User enters 60AAAAAAAAAAAAAAA5 on CE1179 Multiple Enter Movement Reference Number Page")
      CE1179_Multiple_EnterMovementReferenceNumberPage.waitForPageHeader
      CE1179_Multiple_EnterMovementReferenceNumberPage.enterDetails("60AAAAAAAAAAAAAAA5")
      ...
      When("User selects A80 on CE1179 Multiple Select Duties 1 Page")
      CE1179_Multiple_SelectDuties1Page.waitForPageHeader
      CE1179_Multiple_SelectDuties1Page.selectBoxes("A80".split(","))
      ...
      When("User selects A90 on CE1179 Multiple Select Duties 2 Page")
      CE1179_Multiple_SelectDuties2Page.waitForPageHeader
      CE1179_Multiple_SelectDuties2Page.selectBoxes("A90".split(","))
      ...
      And("User selects radio button Declarant on CE1179 Multiple Choose Payee Type Page")
      CE1179_Multiple_ChoosePayeeTypePage.waitForPageHeader
      CE1179_Multiple_ChoosePayeeTypePage.clickRadioButton("Declarant")
      ...
      And("User clicks continue on UDF Choose Files Page")
      UDF_ChooseFilesPage.waitForPageHeader
      UDF_ChooseFilesPage.clickContinueButton()

      Then("User is presented with the UDF Choose Files Page error page")
      UDF_ChooseFilesPage.waitForPageHeader
      UDF_ChooseFilesPage.checkURL
      UDF_ChooseFilesPage.checkPageErrorTitle()

      When("User uploads a 1 image.jpg file on UDF Choose Files Page")
      UDF_ChooseFilesPage.uploadDocument(1, "image.jpg")
      UDF_ChooseFilesPage.waitForPageToLoad()
      ...
      val expectedData = Map(
        "Reason for claim"                       -> "Goods are defective",
        "Personal details"                        -> "John Smith,john@smith.com,01234567890",
        "Uploaded files"                          -> "Commercial invoice:,image.jpg",
        "Address"                                 -> "12 Skybricks Road,Coventry,CV3 6EA,United Kingdom",
        "Bank details"                            -> "Mr John Smith,123456,11001001",
        "Payee"                                   -> "Declarant",
        "Total"                                   -> "£20.00",
        "2nd MRN20AAAAAAAAAAAAAAA1"               -> "£10.00",
        "1st MRN60AAAAAAAAAAAAAAA5"               -> "£10.00",
