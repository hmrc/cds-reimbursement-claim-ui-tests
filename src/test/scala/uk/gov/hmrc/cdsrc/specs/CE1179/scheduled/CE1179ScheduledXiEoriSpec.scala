...
class CE1179ScheduledXiEoriSpec extends BaseSpec {
  ...
  Feature("C&E1179 Scheduled - XIEORI") {
    ...
    Scenario("happy path - check importer/declarant eori pages, Special circumstances") {
      ...
      When("User enters 10AAAXICDAAAAAAAA1 on CE1179 Scheduled Enter Movement Reference Number Page")
      CE1179_Scheduled_EnterMovementReferenceNumberPage.waitForPageHeader
      CE1179_Scheduled_EnterMovementReferenceNumberPage.enterDetails("10AAAXICDAAAAAAAA1")
      ...
      When("User enters XI000000000000001 on CE1179 Scheduled Enter Importer Eori Page")
      CE1179_Scheduled_EnterImporterEoriPage.waitForPageHeader
      CE1179_Scheduled_EnterImporterEoriPage.enterDetails("XI000000000000001")
      ...
      When("User enters XI000000000000001 on CE1179 Scheduled Enter Declarant Eori Page")
      CE1179_Scheduled_EnterDeclarantEoriPage.waitForPageHeader
      CE1179_Scheduled_EnterDeclarantEoriPage.enterDetails("XI000000000000001")
      ...
      val expectedData = Map(
        ...
        "Total"                                     -> "£80.00",
        "First Movement Reference Number (MRN)"     -> "10AAAXICDAAAAAAAA1",
