...
class SingleClaimBasisV2Spec extends BaseSpec {
  ...
  Feature("C285 Single Claim Basis V2") {
    ...
    Scenario("happy path - Duplicate Movement Reference Number (MRN)") {
      ...
      val expectedData = Map(
        ...
        "Movement Reference Number (MRN)" -> "10AAAAAAAAAAAAAAA1"
      )
    ...
    Scenario("happy path - excise duty selected") {
      ...
      And("User enters Enrollment Key, ID Name and ID Value on Auth Login Stub Page")
      AuthLoginStubPage.enrolments("HMRC-CUS-ORG", "EORINumber", "GB000000000000002")
      ...
      When("User enters 10AAAAAAAAAAAAAAA3 on C285 Single Enter Movement Reference Number Page v2")
      C285_Single_EnterMovementReferenceNumberPagev2.waitForPageHeader
      C285_Single_EnterMovementReferenceNumberPagev2.enterDetails("10AAAAAAAAAAAAAAA3")
      ...
      When("User selects radio button Incorrect excise value on C285 Single Choose Basis For Claim Page v2")
      C285_Single_ChooseBasisForClaimPagev2.waitForPageHeader
      C285_Single_ChooseBasisForClaimPagev2.clickRadioButton("Incorrect excise value")
      ...
      When("User selects 421,623,99C on C285 Single Select Duties Page v2")
      C285_Single_SelectDutiesPagev2.waitForPageHeader
      C285_Single_SelectDutiesPagev2.selectBoxes("421,623,99C".split(","))

      And("User clicks continue on C285 Single Select Duties Page v2")
      C285_Single_SelectDutiesPagev2.waitForPageHeader
      C285_Single_SelectDutiesPagev2.clickContinueButton()

      Then("User is presented with the C285 Single Enter Claim Page v2 - Excise Duty - 421 Made-wine")
      C285_Single_EnterClaimPagev2.waitForPageHeader
      C285_Single_EnterClaimPagev2.checkURL
      C285_Single_EnterClaimPagev2.checkPageTitle("Excise Duty - 421 Made-wine")
      ...
      Then("User is presented with the C285 Single Enter Claim Page v2 - Excise Duty - 623 Tobacco products")
      C285_Single_EnterClaimPagev2.waitForPageHeader
      C285_Single_EnterClaimPagev2.checkURL
      C285_Single_EnterClaimPagev2.checkPageTitle("Excise Duty - 623 Tobacco products")
      ...
      Then("User is presented with the C285 Single Enter Claim Page v2 - Excise Duty - 99C Climate Change Levy")
      C285_Single_EnterClaimPagev2.waitForPageHeader
      C285_Single_EnterClaimPagev2.checkURL
      C285_Single_EnterClaimPagev2.checkPageTitle("Excise Duty - 99C Climate Change Levy")
      ...
      When("User selects radio button Bank account transfer on C285 Single Select Reimbursement Method Page v2")
      C285_Single_SelectReimbursementMethodPagev2.waitForPageHeader
      C285_Single_SelectReimbursementMethodPagev2.clickRadioButton("Bank account transfer")
      ...
      And("User should see the following details")
      val expectedData = Map(
        "Reason for claim"             -> "Incorrect excise value",
        "Personal details"             -> "Mr John Smith,someemail@mail.com,01234567890",
        "Uploaded files"               -> "Commercial invoice:,document.pdf",
        "Address"                      -> "12 Skybricks Road,Coventry,CV3 6EA,United Kingdom",
        "Bank details"                 -> "Mr John Smith,123456,11001001",
        "Payee"                        -> "Importer",
        "Additional claim information" -> "under 500 characters",
        "What do you want to claim?"   -> "421 - Sparkling, 8.5% and above but not exceeding 15%,623 - Other smoking tobacco,99C - Gas supplied by a gas utility or any gas supplied in a gaseous state that is of a kind supplied by a gas utility Great Britain",
        "421 - Sparkling, 8.5% and above but not exceeding 15%"  -> "£10.00",
        "623 - Other smoking tobacco"  -> "£10.00",
        "99C - Gas supplied by a gas utility or any gas supplied in a gaseous state that is of a kind supplied by a gas utility Great Britain" -> "£10.00",
        "Total"                        -> "£30.00",
        "Movement Reference Number (MRN)" -> "10AAAAAAAAAAAAAAA3",
        "Method"                       -> "Bank account transfer"
      )
      expectedData.foreach { case (k, v) => info(s"- $k: $v") }
      C285_Single_CheckAnswersAcceptSendPagev2.pageData should be(expectedData)
